                           ...
                           <div class="row m-t-30">
                              <form method="POST" id="edit_profile_form" data-parsley-validate class="form-horizontal">
                                 <div class="row">
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             ...
                                             <input type="text" name="first_name" id="first_name" value="<?php echo $user_data['first_name'];?>" placeholder="First Name" data-parsley-required="true" class="form-control" />
                                          </div>
                                       </div>
                                       <div class="col-md-6">
                                          <div class="form-group">
                                             <label class="form-label" for="form6Example2">Last name</label>
                                             <input type="text" name="last_name" id="last_name" value="<?php echo $user_data['last_name'];?>" placeholder="Last Name" data-parsley-required="true" class="form-control" />
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          <p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
                                             ...
                                             <label>
                                                <input type="radio" name="gender" id="gender" value="male" <?php if($user_data['gender'] == 'male'){ echo "checked"; } ?> data-parsley-multiple="gender" checked> Male &nbsp; &nbsp; &nbsp;
                                                
                                                <input type="radio" name="gender" id="gender" value="female" <?php if($user_data['gender'] == 'female'){ echo "checked"; } ?> data-parsley-multiple="gender"> Female
                                             </label>
                                          </p>
                                       </div>
                                    </div>
                                 ...
                                 <!-- <div class="form-outline mb-4">
                                       <label class="text-center">Profile Pic <br>
                                          ...
                                          <div id="upload<?php echo $i; ?>"
                                             ...
                                             <?php
                                                   $image_name = $user_data['profile_pic'];
                                                      ...
                                                      {
                                                         ?>
                                             <img src="<?php echo $base_url_uploads; ?>profile-pic/size_100/<?php echo $image_name; ?>"
