                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Select cities : <span class="text-danger">*</span></label>
                                                    ...
                                                    ?>
                                                    <select class="select-search form-control" id="cities_id" onchange="invalidate_parsley(this.id)"
                                                            name="city_id" data-parsley-required="true" data-placeholder="Select a City...">
                                                        <option></option>
                                                        <?php foreach ($all_cities_data_array as $all_cities_data)
                                                        { ?>
                                                            <option value="<?php echo $all_cities_data['id']; ?>"><?php echo $all_cities_data['city_name']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
