                                ...
                                <div class="panel-body">
                                    ...
                                    <form id="<?php echo $module_name; ?>_form" method="POST" data-parsley-validate>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="select-search form-control" id="country_id"
                                                            ...
                                                            onchange="if(this.value) get_state(this.value, 0);invalidate_parsley(this.id)"
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="city_title"
                                                           name="city_title"
                                        ...
                                        <div style="margin-top:25px">
                                            <div class="text-left">
                                                <button type="reset" class="btn btn-default" id="city_reset"><i class=" icon-undo position-left"></i> Reset</button>
...
//            debugger;
        ...
        function get_state(country_id, edit_flag=0)
        {
            ...
            if ($('#state_id').size() > 0)
            {
//                $('#<?php //echo $module_name; ?>//_form').parsley('removeItem', '#state_id');
