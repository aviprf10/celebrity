...
if ($admin == 1)
{
    if (isset($_POST))
    {
        ...
        $get_category_title_query = "select * from gift_subcat where giftsubcate_name='$giftsubcate_name' and giftcate_id='$giftcate_id' and is_deleted='0'";
        ...
        $sub_category_unique_slug = get_unique_slug1($db_mysqli, $giftsubcate_name, 'gift_subcat', 'giftsubcate_name');

        $insert_category_query = "INSERT INTO gift_subcat (giftcate_id,giftsubcate_name, giftsubcate_slug, giftsubcate_images,meta_title, meta_keyword, meta_description, created_on, status, is_deleted) 
                                              VALUES ('$giftcate_id','$giftsubcate_name','$sub_category_unique_slug', '$images','$meta_title','$search_keywords','$meta_description', '$created_on','$status', '0');";
