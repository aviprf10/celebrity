...
if ($admin == 1)
{
    $module_full_name = "Gift Sub Category";
    $module_short_name = 'Gift Sub Category';
    $module_name = "gift-sub-category";
                                ...
                                <div class="panel-body">
                                    ...
                                    <form id="<?php echo $module_name; ?>_form" method="POST" data-parsley-validate>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Select Gift Category : <span class="text-danger">*</span></label>

                                                    <?php
                                                    $all_gift_cat_data_array = array();
                                                    $get_gift_cat_query = "SELECT * FROM gift_cat WHERE  is_deleted='0'";
                                                    ...
                                                    ?>
                                                    <select class="select-search form-control" id="giftcate_id" onchange="invalidate_parsley(this.id)"
                                                            name="giftcate_id" data-parsley-required="true" data-placeholder="Select a Gift Category...">
                                                        <option></option>
                                                        <?php foreach ($all_gift_cat_data_array as $all_gift_cat_data)
                                                        { ?>
                                                            <option value="<?php echo $all_gift_cat_data['id']; ?>"><?php echo $all_gift_cat_data['gift_name']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="giftsubcate_name"
                                                           name="giftsubcate_name"
                                        ...
                                        <div style="margin-top:25px">
                                            <div class="text-left">
                                                <button type="reset" id="gift_cat_reset" onclick="reset_photo();" class="btn btn-default"><i class=" icon-undo position-left"></i> Reset</button>
    ...
    <script type="text/javascript">
                    ...
                    $.ajax(
                        {
                            ...
                            success: function (data)
                            {
                                ...
                                if (data.status == 'success')
                                {
                                    ...
                                    setTimeout(function ()
                                    {
                                        window.top.location="<?php echo $base_url; ?>view-gift-sub-category";
                                    }, 2000);
        ...
        $("#gift_cat_reset").click(function ()
        {
            $('#selected_gift_cat_id').select2("val", "0");
        ...
        $(function ()
        {
                ...
                action: '<?php echo $base_url; ?>upload-gift-sub-category-image.php',
                name: 'uploadfile',
