                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    ?>
                                                    <select class="select-search form-control" id="giftsubcat_id" onchange="invalidate_parsley(this.id)"
                                                            name="giftsubcat_id" data-parsley-required="true" data-placeholder="Select a Gift Category...">
                                                        <option></option>
                                                        <?php foreach ($all_category_data_array as $all_category_data)
                                                        { ?>
                                                            <option value="<?php echo $all_category_data['id']; ?>"><?php echo $all_category_data['giftsubcate_name']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="giftsubsubcate_name"
                                                           name="giftsubsubcate_name"
