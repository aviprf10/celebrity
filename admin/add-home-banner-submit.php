...
if($admin == 1)
{
	if($_POST)
	{
		...
		$title_4 = Secure1($db_mysqli,$_POST['title_4']);
		...
		else
		{
			...
			$insert_home_banner_query = "INSERT INTO home_banner (title_1, title_2, title_3, title_4, redirect_url,images,small_images,created_on,status, is_deleted) VALUES ('$title_2','$title_1','$title_3','$title_4', '$redirect_url','$images','$smallimages', '$created_on', '$status','0');";
