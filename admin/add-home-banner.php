										...
										<div class="row">
											<div class="col-md-3">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="title_1" name="title_1" placeholder="Enter Title 1"  data-parsley-required="true" maxlength="25">
												</div>
											</div>
											<div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Title 2 : <span class="text-danger">*</span></label>
													<input type="text" class="form-control" id="title_2" name="title_2" placeholder="Enter Title 2"  data-parsley-required="true" maxlength="100">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Title 3 : <span class="text-danger">*</span></label>
													<input type="text" class="form-control" id="title_3" name="title_3" placeholder="Enter Title 3"  data-parsley-required="true">
                                                </div>
                                            </div>
											<div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Title 4 : <span class="text-danger">*</span></label>
													<input type="text" class="form-control" id="title_4" name="title_4" placeholder="Enter Title 4"  data-parsley-required="true">
                                                </div>
                                            </div>
                                        </div> 
										<div class="row">
											<div class="col-md-6">
                                                <div class="form-group">
													...
													<input type="text" class="form-control" id="redirect_url" name="redirect_url" placeholder="Enter Redirect Url"  data-parsley-required="true">
                                                </div>
                                            </div>
										</div>	
										<div class="row">
