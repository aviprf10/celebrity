										...
										<div class="row">
											<div class="col-md-4">
												<div class="form-group">
                                                    ...
                                                    ?>
                                                    <select class="select-search form-control" id="menu_id" onchange="invalidate_parsley(this.id)"
                                                            name="menu_id" data-parsley-required="true" data-placeholder="Select a Menu...">
                                                        <option></option>
                                                        <?php foreach ($all_menu_data_array as $all_menu_data)
                                                        { ?>
                                                            <option value="<?php echo $all_menu_data['id']; ?>"><?php echo $all_menu_data['menu_name']; ?></option>
                                                        <?php } ?>
                                                    </select>
												</div>
											</div>
