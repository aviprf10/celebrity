...
if ($admin == 1 || ($sub_admin == 1 && $is_menu_write == 1)) {
    if ($_POST) {
        ...
        $branch_id = Secure1($db_mysqli, $_POST['branch_id']);
        ...
        $get_menu_query = "select * from menu where menu_name='$menu_name' and branch_id='$branch_id' and is_deleted='0'";
        ...
        if (!empty($all_menu_data_array)) {
            ...
            $insert_menu_query = "INSERT INTO menu (menu_name,branch_id,price,created_on,status) VALUES ('$menu_name','$branch_id', '$price','$created_on','$status');";
