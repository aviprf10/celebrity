                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    $get_branch_query = "SELECT * FROM branch WHERE  is_deleted='0'";
                                                    ...
                                                    ?>
                                                    <select class="select-search form-control" id="branch_id" onchange="invalidate_parsley(this.id)"
                                                            name="branch_id" data-parsley-required="true" data-placeholder="Select a branch...">
                                                        <option></option>
                                                        <?php foreach ($all_branch_data_array as $all_branch_data)
                                                        { ?>
                                                            <option value="<?php echo $all_branch_data['id']; ?>"><?php echo $all_branch_data['name']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type='number' pattern='[0-9]+(\\.[0-9][0-9]?)?' class="form-control" id="price" name="price"
                    ...
                    $.ajax(
                        {
                            ...
                            success: function (data)
                            {
                                ...
                                if (data.status == 'success')
                                {
                                    ...
                                    setTimeout(function ()
                                    {
                                        window.top.location="<?php echo $base_url; ?>view-menu";
                                    }, 2000);
                                }
                                else
                                {
