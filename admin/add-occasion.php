...
if ($admin == 1)
{
                                ...
                                <div class="panel-body">
                                    <form id="<?php echo $module_name; ?>_form" method="POST" data-parsley-validate>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label><?php echo $module_full_name; ?> Title : <span class="text-danger">*</span></label>
                                                    <input type="text" class="form-control" id="occasion_title"
                                                           name="occasion_title"
                                                           placeholder="Enter <?php echo $module_full_name; ?> Title"
                                        ...
                                        <div style="margin-top:25px">
                                            <div class="text-left">
                                                <button type="reset" id="occasion_reset" onclick="reset_photo();" class="btn btn-default"><i class=" icon-undo position-left"></i> Reset</button>
    ...
    <script type="text/javascript">
        ...
        $("#occasion_reset").click(function ()
        {
            $('#selected_occasion_id').select2("val", "0");
