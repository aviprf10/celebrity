...
if($admin == 1)
{
	if($_POST)
	{
		...
		$get_offer_banner_query = "select * from offer_banner where offer_name='$offer_name' and sequnace_no='$sequnace_no' and  is_deleted='0'";
		...
		else
		{
			...
			$insert_offer_banner_query = "INSERT INTO offer_banner (offer_name, sequnace_no,offer_images, status, is_deleted) VALUES ('$offer_name', '$sequnace_no','$images', '$status','0');";
