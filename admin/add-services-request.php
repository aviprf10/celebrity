...
if ($admin == 1)
{
    $module_full_name = "Services Request";
    $module_short_name = "Services Request";
    $module_name = "services-request";
                    ...
                    $.ajax(
                        {
                            ...
                            success: function (data)
                            {
                                ...
                                if (data.status == 'success')
                                {
                                    ...
                                    setTimeout(function ()
                                    {
                                        window.top.location="<?php echo $base_url; ?>view-services-request";
                                    }, 2000);
