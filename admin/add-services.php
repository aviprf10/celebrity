...
if ($admin == 1)
{
                                    ...
                                    <form id="<?php echo $module_name; ?>_form" method="POST" data-parsley-validate>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" name="is_myself" class="styled" id="is_myself" value="1" checked="checked">
                                                        My Self
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" name="is_someelse" class="styled" id="is_someelse" value="1" checked="checked">
                                                        Someone else
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" name="is_occasion" class="styled" id="is_occasion" value="1" checked="checked">
                                                        Occasion
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" name="is_date" class="styled" id="is_date" value="1" checked="checked">
                                                        Preferred Date
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" name="is_message" class="styled" id="is_message" value="1" checked="checked">
                                                        Message
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div style="margin-top:25px">
                                            <div class="text-left">
                                                <button type="reset" id="services_reset" onclick="reset_photo();" class="btn btn-default"><i class=" icon-undo position-left"></i> Reset</button>
    ...
    <script type="text/javascript">
        ...
        $("#services_reset").click(function ()
        {
            $('#selected_services_id').select2("val", "0");
