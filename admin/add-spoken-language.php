...
if ($admin == 1)
{
                                ...
                                <div class="panel-body">
                                    ...
                                    <form id="<?php echo $module_name; ?>_form" method="POST" data-parsley-validate>
                                        ...
                                        <div style="margin-top:25px">
                                            <div class="text-left">
                                                <button type="reset" id="language_reset" onclick="reset_photo();" class="btn btn-default"><i class=" icon-undo position-left"></i> Reset</button>
    ...
    <script type="text/javascript">
        ...
        $("#language_reset").click(function ()
        {
            $('#selected_language_id').select2("val", "0");
