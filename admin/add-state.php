                                ...
                                <div class="panel-body">
                                    ...
                                    <form id="<?php echo $module_name; ?>_form" method="POST" data-parsley-validate>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    ?>
                                                    <select class="select-search form-control" id="country_id" onchange="invalidate_parsley(this.id)"
                                                            name="country_id" data-parsley-required="true" data-placeholder="Select a Country...">
                                                        <option></option>
                                        ...
                                        <div style="margin-top:25px">
                                            <div class="text-left">
                                                <button type="reset" id="state_reset" class="btn btn-default"><i class=" icon-undo position-left"></i> Reset</button>
                    ...
                    $.ajax(
                        {
                            ...
                            success: function (data)
                            {
                                ...
                                if (data.status == 'success')
                                {
                                    ...
                                    setTimeout(function ()
                                    {
                                        window.top.location="<?php echo $base_url; ?>view-state";
                                    }, 2000);
                                }
                                else
                                {
