...
if ($admin == 1)
{
    if (isset($_POST))
    {
        ...
        $insert_category_query = "INSERT INTO sub_category (category_id,sub_category_name, sub_category_unique_slug, sub_category_imges,meta_title, meta_keyword, meta_description, created_on, status, is_deleted) 
                                              VALUES ('$category_id','$sub_category_name','$sub_category_unique_slug', '$images','$meta_title','$search_keywords','$meta_description', '$created_on','$status', '0');";
