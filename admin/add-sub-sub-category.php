                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    ?>
                                                    <select class="select-search form-control" id="sub_category_id" onchange="invalidate_parsley(this.id)"
                                                            name="sub_category_id" data-parsley-required="true" data-placeholder="Select a category...">
                                                        <option></option>
                                                        <?php foreach ($all_category_data_array as $all_category_data)
                                                        { ?>
                                                            <option value="<?php echo $all_category_data['id']; ?>"><?php echo $all_category_data['sub_category_name']; ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="sub_sub_category_name"
                    ...
                    $.ajax(
                        {
                            ...
                            success: function (data)
                            {
                                ...
                                if (data.status == 'success')
                                {
                                    ...
                                    setTimeout(function ()
                                    {
                                        window.top.location="<?php echo $base_url; ?>view-sub-sub-category";
                                    }, 2000);
