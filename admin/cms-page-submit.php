    ...
    if (isset($_POST))
    {
        ...
        if (count($all_cms_page_data_array) > 0)
        {
            $update_application_request_query = "UPDATE cms_page
                                                    SET page_content = '$page_content', meta_title='$meta_title', image_name= '$image_name', meta_description = '$meta_description', search_keywords = '$search_keywords', status = '$status'
