...
if ($admin == 1 || ($sub_admin == 1 && $is_area_write == 1))
{
    ...
    {
        $module_full_name = 'Area';
        $module_short_name = 'Area';
        $module_name = 'area';
        $edit_id = $_GET['id'];
        ...
        {
            $edit_data_array[] = $row_get_area_query;
        }
        ?>
        <!DOCTYPE html>
        <html lang="en">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label>Select cities : <span
                                                                    class="text-danger">*</span></label>

                                                            <?php
                                                            $all_cities_data_array = array();
                                                            $get_cities_query = "SELECT * FROM cities WHERE is_deleted='0' and state_id BETWEEN 1 and 41";
                                                            $result_get_cities_query = mysqli_query($db_mysqli, $get_cities_query);
                                                            while ($row_get_cities_query = mysqli_fetch_assoc($result_get_cities_query))
                                                            {
                                                                $all_cities_data_array[] = $row_get_cities_query;
                                                            }

                                                            ?>
                                                            <select class="select-search form-control" id="city_id"
                                                                    name="city_id">
                                                                <!--                                                                <option value=""> select cities</option>-->
                                                                <?php foreach ($all_cities_data_array as $all_cities_data)
                                                                { ?>
                                                                    <option
                                                                        value="<?php echo $all_cities_data['id']; ?>"
                                                                        <?php if ($all_cities_data['id'] == $edit_data_array[0]['city_id'])
                                                                        {
                                                                            echo " selected='selected'";
                                                                        } ?>>
                                                                        <?php echo $all_cities_data['city_name']; ?>
                                                                    </option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="name"
                                                                   name="name"
                                                                   value="<?php echo $edit_data_array[0]['name']; ?>"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="pincode"
                                                                   name="pincode"
                                                                   value="<?php echo $edit_data_array[0]['pincode']; ?>"
                        ...
                        $.ajax(
                            {
                                ...
                                success: function (data)
                                {
                                    ...
                                    if (data.status == 'success')
                                    {
                                        ...
                                        setTimeout(function ()
                                        {
                                            window.top.location="<?php echo $base_url; ?>view-area";
                                        }, 2000);
                                    }
                                    else
                                    {
