...
if ($admin == 1)
{
    ...
    {
        $module_full_name = 'Branch';
        $module_short_name = 'Branch';
        $module_name = 'branch';
        ...
        {
            $edit_data_array[] = $row_get_branch_query;
        }
        ?>
        <!DOCTYPE html>
        <html lang="en">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="code" name="code" placeholder="Enter Code"  data-parsley-required="true" value="<?php echo $edit_data_array[0]['code']; ?>">
                                                        </div>
                                                    </div>
                                                </div> 
                                                <div class="row">
                                                                    ...
                                                                    <div id="upload<?php echo $i; ?>"
                                                                        ...
                                                                        <ul class="" id="files<?php echo $i; ?>"
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/branch-images/size_small/<?php echo $edit_data_array[0]['images']; ?>"
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo $base_url_css_upload; ?>styles.css"/>
                            ...
                            $.ajax(
                                {
                                    ...
                                    success: function (data)
                                    {
                                        ...
                                        if (data.status == 'success')
                                        {
                                            ...
                                            setTimeout(function ()
                                            {
                                                window.top.location="<?php echo $base_url; ?>view-branch";
                                            }, 2000);
                                        }
                                        else
                                        {
            ...
            $(function ()
            {
                ...
                new AjaxUpload(btnUpload, {
                    action: '<?php echo $base_url; ?>upload-branch-image.php',
                    name: 'uploadfile',
