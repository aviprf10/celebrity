                                                                    ...
                                                                    { ?>
                                                                        <div id="upload<?php echo $i; ?>"
                                                                            ...
                                                                            <ul class="" id="files<?php echo $i; ?>"
                                                                                ...
                                                                                <?php
                                                                                if ($edit_data_array[0]['category_images'] != '')
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/category-images/size_small/<?php echo $edit_data_array[0]['category_images']; ?>"
                                                                            ...
                                                                            <input type="hidden" name="file_name<?php echo $i; ?>"
                                                                                    id="file_name<?php echo $i; ?>" value="<?php echo $edit_data_array[0]['category_images']; ?>">
                                                                        </div>
                                                                        <?php
                                                                    } ?>
                                                                    <div style="clear:both"></div>
