...
if ($admin == 1)
{
    if (isset($_GET['id']))
    {
        $module_full_name = "Celebrity Price";
        $module_short_name = "Celebrity Price";
        $module_name = "celebrity-price";

         $edit_id = $_GET['id'];

        $edit_data_array = array();
        $get_category_query = "select * from celebrity_price where id='$edit_id'";
         ...
         if (!empty($edit_data_array))
        {
            ...
            $discount_price = $edit_data['discount_price'];
            $status = $edit_data['status'];
            $celebrity_id = $edit_data['celebrity_id'];
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" name="celebrity_id" id="celebrity_id"  value="<?php echo $celebrity_id; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Discount Type :</label>
                                                            <input type="text" class="form-control" value="<?php echo $discount_type; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" value="<?php echo $discount_price; ?>">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="status">
                                                                ...
                                                                <option value="0" <?php if($status == 0){ echo 'selected';} ?>>Pendding</option>
                                                            </select>
            ...
            <script type="text/javascript">
                            ...
                            $.ajax(
                                {
                                    ...
                                    success: function (data)
                                    {
                                        ...
                                        if (data.status == 'success')
                                        {
                                            ...
                                            setTimeout(function ()
                                            {
                                                window.top.location="<?php echo $base_url; ?>view-category";
                                            }, 2000);
                                        }
                                        else
                                        {
                ...
                $(function ()
                {
                    ...
                    new AjaxUpload(btnUpload, {
                        action: '<?php echo $base_url; ?>upload-category-image.php',
                        name: 'uploadfile',
