...
if ($admin == 1)
{
    ...
    if (isset($edit_id))
    {
        ...
        $category_id = $celebritydetails_data_array[0]['category_id'];
        $sub_category_id = $celebritydetails_data_array[0]['sub_category_id'];
        $sub_sub_category_id = $celebritydetails_data_array[0]['sub_sub_category_id'];
        $giftcat_id = $celebritydetails_data_array[0]['giftcat_id'];
        $giftsubcat_id = $celebritydetails_data_array[0]['giftsubcat_id'];
        $giftsubsubcat_id = $celebritydetails_data_array[0]['giftsubsubcat_id'];
        $full_description = $celebritydetails_data_array[0]['full_description'];
        $language_spoken = $celebritydetails_data_array[0]['language_spoken'];
        $meta_title = $celebritydetails_data_array[0]['meta_title'];
        $meta_keyword = $celebritydetails_data_array[0]['meta_keyword'];
        $meta_description = $celebritydetails_data_array[0]['meta_description'];
        $brand_celebration_price = $celebritydetails_data_array[0]['brand_celebration_price'];
        $follower_count = $celebritydetails_data_array[0]['follower_count'];
        $payment_percentage = $celebritydetails_data_array[0]['payment_percentage'];
                                        ...
                                        <form id="<?php echo $module_name; ?>_form" method="POST" data-parsley-validate>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select form-control" id="user_type" name="user_type" >
                                                            ...
                                                            <option value="2" <?php if($edit_data_array[0]['user_type']==2){ echo 'selected';} ?> selected>Celebrity</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="password" class="form-control" id="password"
                                                            ...
                                                            data-parsley-required="true" value="<?php echo $edit_data_array[0]['password'] ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                            ...
                                            <div class="row"> 
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" name="brand_celebration_price" data-parsley-required="true" id="brand_celebration_price" value="<?php echo $brand_celebration_price; ?>" class="form-control" placeholder="Brand Celebration Price">
                                                </div>
                                                <div class="col-md-3">
                                            ...
                                            <?php 
                                            $get_celebrityprice_query = "select * from celebrity_price where celebrity_id='$edit_id'";
                                            ...
                                            <div class="row" <?php if($is_pramotion == 1){ ?>style="display:none;" <?php }else{ ?>id="services_div"<?php } ?>>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input type="text" name="price_<?php echo $celebrityprice_entry_count; ?>" id="price_<?php echo $celebrityprice_entry_count; ?>"  data-parsley-required="true" value="<?php echo $celebrityprice['price']; ?>" class="form-control" placeholder="Price" min="100">
                                                </div> 
                                                <div class="col-md-3">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text"   class="form-control" name="full_description"
                                                            placeholder="Enter Full Description " rows="5" maxlength="500"><?php echo $full_description; ?></textarea>
                                                    </div>
                                                </div>
                                            </div> 
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"id="profile_link_url" name="profile_link_url"
                                                                placeholder="Enter Profile Details Link " value="<?php echo $edit_data_array[0]['profile_link_url']; ?> ">                                                
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control" type="text" data-parsley-required="true" name="follower_count" id="follower_count" value="<?php echo $follower_count; ?>">
                                                    <!-- <div class="range-slider">
                                                        <input class="range-slider__range" type="range" data-parsley-required="true" name="follower_count" id="follower_count" <?php if($follower_count!=''){ ?>value="<?php echo $follower_count; ?>"<?php }else{ ?> value="1000"<?php } ?> min="1000" max="10000000">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="search_keywords" name="search_keywords[]" type="text" value="<?php echo $meta_keyword; ?>" class="form-control tags"  placeholder="Enter Search Terms"/>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="payment_percentage" name="payment_percentage" value="<?php echo $payment_percentage; ?>"
                                                                    ...
                                                                    <div id="upload<?php echo $i; ?>" style="width:160px;height:160px;padding: 0px;border: 1px solid #dedede;"
                                                                        ...
                                                                        <ul class="" id="files<?php echo $i; ?>"
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $cele_base_path_uploads; ?>profile-pic/size_450/<?php echo $profile_pic; ?>"
