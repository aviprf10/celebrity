...
if ($admin == 1 || ($sub_admin == 1 && $is_country_write == 1))
{
    if (isset($_GET['id']) && $_GET['id'] > 0)
    {
        ...
        {
            $edit_data_array[] = $row_get_country_query;
        }
        ?>
        <!DOCTYPE html>
        <html lang="en">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="title" name="title" value="<?php echo $edit_data_array[0]['country_name']; ?>"
                                                                   placeholder="Enter <?php echo $module_full_name; ?>" data-parsley-required="true">
        ...
        <script type="text/javascript">
                        ...
                        $.ajax(
                            {
                                ...
                                success: function (data)
                                {
                                    ...
                                    if (data.status == 'success')
                                    {
                                        ...
                                        setTimeout(function ()
                                        {
                                            window.top.location="<?php echo $base_url; ?>view-country";
                                        }, 2000);
                                    }
                                    else
                                    {
            ...
            {
                window.location.href = "<?php echo $base_url; ?>view-<?php echo $module_name; ?>";
            });
        </script>
