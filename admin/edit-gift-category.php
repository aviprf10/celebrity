...
if ($admin == 1)
{
    if (isset($_GET['id']))
    {
        $module_full_name = "Gift Category";
        $module_short_name = "Gift Category";
        $module_name = "gift-category";
        ...
        {
            $edit_data_array[] = $row_get_gift_cat_query;
        }

         if (!empty($edit_data_array))
        {
            $edit_data = $edit_data_array[0];
            $gift_id = $edit_data['id'];
            $gift_name = $edit_data['gift_name'];
                                                                    ...
                                                                    { ?>
                                                                        <div id="upload<?php echo $i; ?>"
                                                                            ...
                                                                            <ul class="" id="files<?php echo $i; ?>"
                                                                                ...
                                                                                <?php
                                                                                if ($edit_data_array[0]['gift_images'] != '')
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/gift-category-images/size_small/<?php echo $edit_data_array[0]['gift_images']; ?>"
                                                                            ...
                                                                            <input type="hidden" name="file_name<?php echo $i; ?>"
                                                                                    id="file_name<?php echo $i; ?>" value="<?php echo $edit_data_array[0]['gift_images']; ?>">
                                                                        </div>
                                                                        <?php
                                                                    } ?>
                                                                    <div style="clear:both"></div>
            ...
            <script type="text/javascript">
                            ...
                            $.ajax(
                                {
                                    ...
                                    success: function (data)
                                    {
                                        ...
                                        if (data.status == 'success')
                                        {
                                            ...
                                            setTimeout(function ()
                                            {
                                                window.top.location="<?php echo $base_url; ?>view-gift-category";
                                            }, 2000);
                                        }
                                        else
                                        {
                ...
                $(function ()
                {
                    ...
                    new AjaxUpload(btnUpload, {
                        action: '<?php echo $base_url; ?>upload-gift-category-image.php',
                        name: 'uploadfile',
