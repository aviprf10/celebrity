...
if ($admin == 1)
{
    if (isset($_GET['id']))
    {
         ...
         if (count($edit_data_array) > 0)
        {
            ...
            $giftcate_id = $edit_data['giftcate_id'];
            $giftsubcate_name = $edit_data['giftsubcate_name'];
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                $get_category_query = "SELECT * FROM gift_cat WHERE is_deleted='0'";
                                                                $result_get_category_query = mysqli_query($db_mysqli, $get_category_query);
                                                                while ($row_get_category_query = mysqli_fetch_assoc($result_get_category_query))
                                                                {
                                                                ...
                                                                $giftcate_id = $edit_data_array[0]['giftcate_id'];


                                                                ?>
                                                                <select class="select-search form-control" id="giftcate_id"
                                                                        name="giftcate_id">
                                                                    ...
                                                                    { ?>
                                                                        <option
                                                                            ...
                                                                            <?php if ($all_category_data['id'] == $edit_data_array[0]['giftcate_id'])
                                                                            {
                                                                                echo " selected='selected'";
                                                                            } ?>>
                                                                            <?php echo $all_category_data['gift_name']; ?>
                                                                        </option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label><?php echo $module_full_name; ?> Title : <span
                                                                        class="text-danger">*</span></label>
                                                                <input type="text" class="form-control" name="giftsubcate_name"
                                                                       id="giftsubcate_name"
                                                                       placeholder="<?php echo $module_full_name; ?> Title"
                                                                       value="<?php echo $giftsubcate_name; ?>"
                                                                    ...
                                                                    { ?>
                                                                        <div id="upload<?php echo $i; ?>"
                                                                            ...
                                                                            <ul class="" id="files<?php echo $i; ?>"
                                                                                ...
                                                                                <?php
                                                                                if ($edit_data_array[0]['giftsubcate_images'] != '')
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/gift-sub-category-images/size_small/<?php echo $edit_data_array[0]['giftsubcate_images']; ?>"
                                                                            ...
                                                                            <input type="hidden" name="file_name<?php echo $i; ?>"
                                                                                    id="file_name<?php echo $i; ?>" value="<?php echo $edit_data_array[0]['giftsubcate_images']; ?>">
                                                                        </div>
                                                                        <?php
                                                                    } ?>
                                                                    <div style="clear:both"></div>
