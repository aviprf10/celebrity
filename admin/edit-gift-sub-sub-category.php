...
if ($admin == 1)
{
    if (isset($_GET['id']))
    {
        $module_full_name = "Gift Sub Sub Category";
        $module_short_name = "Gift Sub Sub Category";
        $module_name = "gift-sub-sub-category";
        ...
        if (count($edit_data_array) > 0)
        {
            ...
            $giftsubcat_id = $edit_data['giftsubcat_id'];
            $giftsubsubcate_name = $edit_data['giftsubsubcate_name'];
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                $get_category_query = "SELECT * FROM gift_subcat WHERE is_deleted='0'";
                                                                $result_get_category_query = mysqli_query($db_mysqli, $get_category_query);
                                                                while ($row_get_category_query = mysqli_fetch_assoc($result_get_category_query))
                                                                {
                                                                ...
                                                                ?>
                                                                <select class="select-search form-control" id="giftsubcat_id"
                                                                        name="giftsubcat_id">
                                                                    ...
                                                                    { ?>
                                                                        <option
                                                                            ...
                                                                            <?php if ($all_category_data['id'] == $edit_data_array[0]['giftsubcat_id'])
                                                                            {
                                                                                echo " selected='selected'";
                                                                            } ?>>
                                                                            <?php echo $all_category_data['giftsubcate_name']; ?>
                                                                        </option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label><?php echo $module_full_name; ?> Title : <span
                                                                        class="text-danger">*</span></label>
                                                                <input type="text" class="form-control" name="giftsubsubcate_name"
                                                                       id="giftsubsubcate_name"
                                                                       placeholder="<?php echo $module_full_name; ?> Title"
                                                                       value="<?php echo $giftsubsubcate_name; ?>"
                                                                    ...
                                                                    { ?>
                                                                        <div id="upload<?php echo $i; ?>"
                                                                            ...
                                                                            <ul class="" id="files<?php echo $i; ?>"
                                                                                ...
                                                                                <?php
                                                                                if ($edit_data_array[0]['giftsubsubcate_images'] != '')
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/gift-sub-sub-category-images/size_small/<?php echo $edit_data_array[0]['giftsubsubcate_images']; ?>"
                                                                            ...
                                                                            <input type="hidden" name="file_name<?php echo $i; ?>"
                                                                                    id="file_name<?php echo $i; ?>" value="<?php echo $edit_data_array[0]['giftsubsubcate_images']; ?>">
                                                                        </div>
                                                                        <?php
                                                                    } ?>
                                                                    <div style="clear:both"></div>
            ...
            <script type="text/javascript">
                            ...
                            $.ajax(
                                {
                                    ...
                                    success: function (data)
                                    {
                                        ...
                                        if (data.status == 'success')
                                        {
                                            ...
                                            setTimeout(function ()
                                            {
                                                window.top.location="<?php echo $base_url; ?>view-gift-sub-sub-category";
                                            }, 2000);
                                        }
                                        else
                                        {
                ...
                $(function ()
                {
                    ...
                    new AjaxUpload(btnUpload, {
                        action: '<?php echo $base_url; ?>upload-gift-sub-sub-category-image.php',
                        name: 'uploadfile',
