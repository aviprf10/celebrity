...
if($admin == 1)
{
	if(isset($_POST))
	{
		...
		if(count($all_home_banner_data_array) > 0)
		{
			...
			$update_home_banner_query = "update home_banner set title_1='$title_1', title_2='$title_2', title_3='$title_3',title_4='$title_4',  redirect_url='$redirect_url', images='$images', small_images='$smallimage',status='$status', updated_on='$created_on' where id='$edit_id'";
