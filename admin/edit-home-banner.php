...
if ($admin == 1)
{
    ...
    {
        $module_full_name = 'Home Banner';
        $module_short_name = 'Home Banner';
        $module_name = 'home-banner';
        ...
        {
            $edit_data_array[] = $row_get_home_banner_query;
        }
        ?>
        <!DOCTYPE html>
        <html lang="en">
                                        ...
                                        { ?>
                                            <form id="<?php echo $module_name; ?>_form" method="POST" data-parsley-validate>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="title_1" name="title_1" placeholder="Enter Title 1"  data-parsley-required="true" value="<?php echo $edit_data_array[0]['title_1']; ?>">
                                                            <input type="hidden" name="edit_id" value="<?php echo $edit_data_array[0]['id']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Title 2: <span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" id="title_2" name="title_2" placeholder="Enter Title 2"  data-parsley-required="true" value="<?php echo $edit_data_array[0]['title_2']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Title 3 : <span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" id="title_3" name="title_3" placeholder="Enter Title 3"  data-parsley-required="true" value="<?php echo $edit_data_array[0]['title_3']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Title 4 : <span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" id="title_4" name="title_4" placeholder="Enter Title 4"  data-parsley-required="true" value="<?php echo $edit_data_array[0]['title_4']; ?>">
                                                        </div>
                                                    </div>
                                                </div> 
                                                <div class="row">    
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="redirect_url" name="redirect_url" placeholder="Enter Redirect Url"  data-parsley-required="true" value="<?php echo $edit_data_array[0]['redirect_url']; ?>">
                                                        </div>
                                                    </div>
                                                </div> 
                                                <div class="row">
                                                <div class="col-md-4" style="margin-top:10px;margin-bottom: 15px;">
                                                        <div class="form-group">
                                                            <label>Upload Small banner image :</label>
                                                            <div style="clear:both"></div>
                                                            <p class="text-primary" style="color:primary">Image Size : , File Size : Max 2 MB   </p>
                                                                ...
                                                                { ?>
                                                                    <div id="upload<?php echo $i; ?>"
                                                                        ...
                                                                        <ul class="" id="files<?php echo $i; ?>"
                                                                            ...
                                                                            <?php
                                                                                if ($edit_data_array[0]['images'] != '')
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/home-banner-small-images/size_small/<?php echo $edit_data_array[0]['images']; ?>"
                                                                        ...
                                                                        <input type="hidden" name="file_name<?php echo $i; ?>"
                                                                               id="file_name<?php echo $i; ?>" value="<?php echo $edit_data_array[0]['images']; ?>">
                                                                    </div>
                                                                    <?php
                                                                } ?>
                                                                <div style="clear:both"></div>
                                                                ...
                                                                { ?>
                                                                    <div id="upload<?php echo $i; ?>"
                                                                        ...
                                                                        <ul class="" id="files<?php echo $i; ?>"
                                                                            style="width: auto;padding: 0px;margin:0px">
                                                                            <?php
                                                                                if ($edit_data_array[0]['small_images'] != '')
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/home-banner-images/size_small/<?php echo $edit_data_array[0]['small_images']; ?>"
                                                                                         style="margin-bottom:20px;width:295px;height:160px;">
                                                                                    <div style="clear:both"></div>
                                                                                    <center><a class="" style="cursor:pointer" onclick="delete_upload(<?php echo $i; ?>)">
                                                                                            <i class="icon icon-subtract"></i>
                                                                        ...
                                                                        <input type="hidden" name="file_name<?php echo $i; ?>"
                                                                               id="file_name<?php echo $i; ?>" value="<?php echo $edit_data_array[0]['small_images']; ?>">
                                                                    </div>
                                                                    <?php
                                                                } ?>
                                                                <div style="clear:both"></div>
                        ...
                        $.ajax(
                            {
                                ...
                                success: function (data)
                                {
                                    ...
                                    if (data.status == 'success')
                                    {
                                        ...
                                        setTimeout(function ()
                                        {
                                            window.top.location="<?php echo $base_url; ?>view-home-banner";
                                        }, 2000);
                                    }
                                    else
                                    {
        ...
        $(function ()
        {
            ...
            new AjaxUpload(btnUpload, {
                action: '<?php echo $base_url; ?>upload-home-banner-image.php',
                name: 'uploadfile',
...
//                    debugger;
        ...
        $(function ()
        {
            ...
            var status = $('#status<?php echo $i; ?>');
            new AjaxUpload(btnUpload, {
                action: '<?php echo $base_url; ?>upload-home-banner-small-image.php',
                name: 'uploadfile',
                onSubmit: function (file, ext)
                {
                    if (!(ext && /^(jpg|png|jpeg|gif)$/.test(ext)))
                ...
                onComplete: function (file, response)
                {
                    ...
                    {
                        document.getElementById('file_name<?php echo $i; ?>').value = file;
                        $('<li></li>').add('#files<?php echo $i; ?>').html('<img src="<?php echo $base_url_uploads;?>home-banner-small-images/size_small/' + file + '" style="margin-bottom:10px;width:290px;height:153px;"  alt="" /><div style="clear:both"></div><a class="" style="cursor:pointor" onclick="delete_uploadsmall(<?php echo $i;?>)"><i class="icon icon-subtract"></i><div style="clear:both"></div>DELETE </a>').addClass('success');
                        $('input').attr('title', ' ');
                    }
                    else if (response == 'size_error')
                    {
        ...
        function delete_uploadsmall(delete_file_id)
        {
            $('#files' + delete_file_id).html('<center style="margin-top: 20px;"><i class="icon icon-add"></i><div style="clear:both"></div>ADD <br/> PHOTO </center>');
            $('#file_name' + delete_file_id).val("");
        }
