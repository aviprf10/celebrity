...
if ($admin == 1)
{
    if (isset($_GET['id']) && $_GET['id'] > 0)
    {
        ...
        $get_menu_images_query = "select * from menu_images where id='$edit_id' and is_deleted='0'";
        ...
        {
            $edit_data_array[] = $row_get_menu_images_query;
        }
        ?>
        <!DOCTYPE html>
        <html lang="en">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                                ...
                                                                $get_menu_query = "SELECT * FROM menu WHERE is_deleted='0'";
                                                                ...
                                                                $menu_id = $edit_data_array[0]['menu_id'];


                                                                ?>
                                                                <select class="select-search form-control" id="menu_id"
                                                                        name="menu_id">
                                                                    <!--                                                                <option value=""> select menu</option>-->
                                                                    <?php foreach ($all_menu_data_array as $all_menu_data)
                                                                    { ?>
                                                                        <option
                                                                            value="<?php echo $all_menu_data['id']; ?>"
                                                                            <?php if ($all_menu_data['id'] == $edit_data_array[0]['menu_id'])
                                                                            {
                                                                                echo " selected='selected'";
                                                                            } ?>>
                                                                            <?php echo $all_menu_data['menu_name']; ?>
                                                                        </option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <label>Name</label>
                                                        <input type="text" name="images_name" id="images_name" placeholder="Enter Name" value="<?php echo $edit_data_array[0]['images_name']; ?>" class="form-control">
                                                    </div>
                                                </div> 
                                                <div class="row">
                                                                ...
                                                                { ?>
                                                                    <div id="upload<?php echo $i; ?>"
                                                                        ...
                                                                        <ul class="" id="files<?php echo $i; ?>"
                                                                            ...
                                                                            <?php
                                                                                if ($edit_data_array[0]['menu_small_images'] != '')
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/menu-small-images/size_small/<?php echo $edit_data_array[0]['menu_small_images']; ?>"
                                                                        ...
                                                                        <input type="hidden" name="file_name<?php echo $i; ?>"
                                                                               id="file_name<?php echo $i; ?>" value="<?php echo $edit_data_array[0]['menu_small_images']; ?>">
                                                                    </div>
                                                                    <?php
                                                                } ?>
                                                                <div style="clear:both"></div>
                                                                ...
                                                                { ?>
                                                                    <div id="upload<?php echo $i; ?>"
                                                                        ...
                                                                        <ul class="" id="files<?php echo $i; ?>"
                                                                            style="width: auto;padding: 0px;margin:0px">
                                                                            <?php
                                                                                if ($edit_data_array[0]['menu_images'] != '')
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/menu-images/size_small/<?php echo $edit_data_array[0]['menu_images']; ?>"
                                                                                         style="margin-bottom:20px;width:295px;height:160px;">
                                                                                    <div style="clear:both"></div>
                                                                                    <center><a class="" style="cursor:pointer" onclick="delete_upload(<?php echo $i; ?>)">
                                                                                            <i class="icon icon-subtract"></i>
                                                                        ...
                                                                        <input type="hidden" name="file_name<?php echo $i; ?>"
                                                                               id="file_name<?php echo $i; ?>" value="<?php echo $edit_data_array[0]['menu_images']; ?>">
                                                                    </div>
                                                                    <?php
                                                                } ?>
                                                                <div style="clear:both"></div>
                        ...
                        $.ajax(
                            {
                                ...
                                success: function (data)
                                {
                                    ...
                                    if (data.status == 'success')
                                    {
                                        ...
                                        setTimeout(function ()
                                        {
                                            window.top.location="<?php echo $base_url; ?>view-menu-images";
                                        }, 2000);
                                    }
                                    else
                                    {
        ...
        $(function ()
        {
            ...
            new AjaxUpload(btnUpload, {
                action: '<?php echo $base_url; ?>upload-menu-image.php',
                name: 'uploadfile',
...
//                    debugger;
        ...
        $(function ()
        {
            ...
            var status = $('#status<?php echo $i; ?>');
            new AjaxUpload(btnUpload, {
                action: '<?php echo $base_url; ?>upload-menu-small-image.php',
                name: 'uploadfile',
                onSubmit: function (file, ext)
                {
                    if (!(ext && /^(jpg|png|jpeg|gif)$/.test(ext)))
...
//                    debugger;
                    ...
                    {
                        document.getElementById('file_name<?php echo $i; ?>').value = file;
                        $('<li></li>').add('#files<?php echo $i; ?>').html('<img src="<?php echo $base_url_uploads;?>menu-small-images/size_small/' + file + '" style="margin-bottom:10px;width:290px;height:153px;"  alt="" /><div style="clear:both"></div><a class="" style="cursor:pointor" onclick="delete_upload_small(<?php echo $i;?>)"><i class="icon icon-subtract"></i><div style="clear:both"></div>DELETE </a>').addClass('success');
                        $('input').attr('title', ' ');
                    }
                    else if (response == 'size_error')
                    {
