                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            ?>
                                                            <select class="select-search form-control" id="branch_id"
                                                                    name="branch_id">
                                                                <!-- <option value=""> select branch</option>-->
                                                                <?php foreach ($all_branch_data_array as $all_branch_data)
                                                                { ?>
                                                                    <option
                                                                        value="<?php echo $all_branch_data['id']; ?>"
                                                                        <?php if ($all_branch_data['id'] == $edit_data_array[0]['branch_id'])
                                                                        {
                                                                            echo " selected='selected'";
                                                                        } ?>>
                                                                        <?php echo $all_branch_data['name']; ?>
                                                                    </option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type='number' pattern='[0-9]+(\\.[0-9][0-9]?)?' class="form-control" id="price"
                                                                   name="price"
