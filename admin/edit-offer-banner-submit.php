...
if($admin == 1)
{
	if(isset($_POST))
	{
		...
		if(count($all_offer_banner_data_array) > 0)
		{
			...
			$check_offer_banner_query = "select * from offer_banner where offer_name='$offer_name' AND sequnace_no='$sequnace_no' AND id != '$edit_id' and is_deleted='0'";
			...
			$update_offer_banner_query = "update offer_banner set offer_name='$offer_name',  sequnace_no='$sequnace_no', offer_images='$images', status='$status' where id='$edit_id'";
