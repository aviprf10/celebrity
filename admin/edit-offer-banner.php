...
if ($admin == 1)
{
    if (isset($_GET['id']) && $_GET['id'] > 0)
    {
        ...
        {
            $edit_data_array[] = $row_get_offer_banner_query;
        }
        ?>
        <!DOCTYPE html>
        <html lang="en">
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h6><i class="icon-offer4 position-left"></i> 
                        ...
                        <div class="page-header page-header-default">
                            <div class="breadcrumb-line">
                                <ul class="breadcrumb">
                                    <li>
                                        <a href="<?php echo $base_url; ?>">
                                            <i class="icon-offer2 position-left"></i>
                                            Dashboard
                                        </a>
                                    </li>
                                                ...
                                                <div class="row">
                                                    <!-- <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select-search form-control" id="category_id" onchange="invalidate_parsley(this.id)"
                                                                ...
                                                                //{ ?>
                                                                    <option value="<?php //echo $all_category_data['id']; ?>" <?php //if($edit_data_array[0]['category_id'] == $all_category_data['id']){ echo 'selected';} ?>><?php //echo $all_category_data['category_name']; ?></option>
                                                                <?php //} ?>
                                                            </select>
                                                        </div>
                                                    </div> -->
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="offer_name" name="offer_name" placeholder="Enter Offer Name"  data-parsley-required="true" value="<?php echo $edit_data_array[0]['offer_name']; ?>">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="select-search form-control" id="sequnace_no" onchange="invalidate_parsley(this.id)"
                                                                ...
                                                                <option></option>
                                                                <option value="1" <?php if($edit_data_array[0]['sequnace_no'] == 1){ echo 'selected'; } ?>>1</option>
                                                                <option value="2" <?php if($edit_data_array[0]['sequnace_no'] == 2){ echo 'selected'; } ?>>2</option>
                                                                <option value="3" <?php if($edit_data_array[0]['sequnace_no'] == 3){ echo 'selected'; } ?>>3</option>
                                                                <option value="4" <?php if($edit_data_array[0]['sequnace_no'] == 4){ echo 'selected'; } ?>>4</option>
                                                                <option value="5" <?php if($edit_data_array[0]['sequnace_no'] == 5){ echo 'selected'; } ?>>5</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div> 
                                                                ...
                                                                { ?>
                                                                    <div id="upload<?php echo $i; ?>"
                                                                        ...
                                                                        <ul class="" id="files<?php echo $i; ?>"
                                                                            ...
                                                                            <?php
                                                                                if ($edit_data_array[0]['offer_images'] != '')
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/offer-banner-images/size_small/<?php echo $edit_data_array[0]['offer_images']; ?>"
                                                                        ...
                                                                        <input type="hidden" name="file_name<?php echo $i; ?>"
                                                                               id="file_name<?php echo $i; ?>" value="<?php echo $edit_data_array[0]['offer_images']; ?>">
                                                                    </div>
                                                                    <?php
                                                                } ?>
                                                                <div style="clear:both"></div>
                        ...
                        $.ajax(
                            {
                                ...
                                success: function (data)
                                {
                                    ...
                                    if (data.status == 'success')
                                    {
                                        ...
                                        setTimeout(function ()
                                        {
                                            window.top.location="<?php echo $base_url; ?>view-offer-banner";
                                        }, 2000);
                                    }
                                    else
                                    {
