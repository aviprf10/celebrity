...
if ($admin == 1)
{
    if (isset($_GET['id']) && $_GET['id'] > 0)
    {
        ...
        $get_product_images_query = "select * from product_images where id='$edit_id' and is_deleted='0'";
        ...
        {
            $edit_data_array[] = $row_get_product_images_query;
        }
        ?>
        <!DOCTYPE html>
        <html lang="en">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                                ...
                                                                $product_id = $edit_data_array[0]['product_id'];


                                                                ?>
                                                                <select class="select-search form-control" id="product_id"
                                                                        name="product_id">
                                                                    <!--                                                                <option value=""> select product</option>-->
                                                                    <?php foreach ($all_product_data_array as $all_product_data)
                                                                    { ?>
                                                                        <option
                                                                            value="<?php echo $all_product_data['id']; ?>"
                                                                            <?php if ($all_product_data['id'] == $edit_data_array[0]['product_id'])
                                                                            {
                                                                                echo " selected='selected'";
                                                                            } ?>>
                                                                            <?php echo $all_product_data['product_name']; ?>
                                                                        </option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                                    ...
                                                                    <div id="upload<?php echo $i; ?>"
                                                                        ...
                                                                        <ul class="" id="files<?php echo $i; ?>"
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/product-small-images/size_small/<?php echo $edit_data_array[0]['product_small_images']; ?>"
                                                                ...
                                                                { ?>
                                                                    <div id="upload<?php echo $i; ?>"
                                                                        ...
                                                                        <ul class="" id="files<?php echo $i; ?>"
                                                                            style="width: auto;padding: 0px;margin:0px">
                                                                            <?php
                                                                                if ($edit_data_array[0]['product_images'] != '')
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/product-images/size_small/<?php echo $edit_data_array[0]['product_images']; ?>"
                                                                                         style="margin-bottom:20px;width:295px;height:160px;">
                                                                                    <div style="clear:both"></div>
                                                                                    <center><a class="" style="cursor:pointer" onclick="delete_upload(<?php echo $i; ?>)">
                                                                                            <i class="icon icon-subtract"></i>
                                                                        ...
                                                                        <input type="hidden" name="file_name<?php echo $i; ?>"
                                                                               id="file_name<?php echo $i; ?>" value="<?php echo $edit_data_array[0]['product_images']; ?>">
                                                                    </div>
                                                                    <?php
                                                                } ?>
                                                                <div style="clear:both"></div>
                        ...
                        $.ajax(
                            {
                                ...
                                success: function (data)
                                {
                                    ...
                                    if (data.status == 'success')
                                    {
                                        ...
                                        setTimeout(function ()
                                        {
                                            window.top.location="<?php echo $base_url; ?>view-product-images";
                                        }, 2000);
                                    }
                                    else
                                    {
