...
if ($admin == 1)
{
    if (isset($_GET['id']) && $_GET['id'] > 0)
    {
        ...
        {
            $edit_data_array[] = $row_get_celebrity_messages_query;
        }
        ?>
        <!DOCTYPE html>
        <html lang="en">
        ...
        <?php
            if ($side_menu_celebrity_messages == 0)
            {
                ?>
           sidebar-xs
        <?php
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2" name="services_id" id="services_id" data-parsley-required="true">
                                                                ...
                                                                ?>
                                                                <option value="<?php echo $services_data['id']; ?>" <?php if($edit_data_array[0]['services_id'] == $services_data['id']){ echo 'selected'; } ?>><?php echo $services_data['services_name']; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2" name="occasion_id" id="occasion_id" data-parsley-required="true">
                                                                ...
                                                                ?>
                                                                <option value="<?php echo $occasion_data['id']; ?>" <?php if($edit_data_array[0]['occasion_id'] == $occasion_data['id']){ echo 'selected'; } ?>><?php echo $occasion_data['occasion_title']; ?></option>
                                                                <?php } ?>
                                                            </select>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control select2" name="type" id="type" data-parsley-required="true">
                                                                ...
                                                                <option value="1" <?php if($edit_data_array[0]['type'] == '1'){ echo 'selected';} ?>>Myself</option>
                                                                <option value="2" <?php if($edit_data_array[0]['type'] == '2'){ echo 'selected';} ?>>Someone else</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="5" type="text" class="form-control" id="celebrity_message"
                                                                   name="celebrity_message"
                                                                  placeholder="Enter Message"  maxlength="300"
                                                                   data-parsley-required="true"><?php echo $edit_data_array[0]['celebrity_message']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
