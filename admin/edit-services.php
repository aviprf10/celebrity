...
if ($admin == 1)
{
    if (isset($_GET['id']))
    {
         ...
         if (!empty($edit_data_array))
        {
            ...
            $services_id = $edit_data['id'];
            $services_name = $edit_data['services_name'];
            $description = $edit_data['description'];
            $is_myself = $edit_data['is_myself'];
            $is_someelse = $edit_data['is_someelse'];
            $is_occasion = $edit_data['is_occasion'];
            $is_date = $edit_data['is_date'];
            $is_message = $edit_data['is_message'];
                                            ...
                                            { ?>
                                                <form id="<?php echo $module_name; ?>_form" method="POST" data-parsley-validate>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label><?php echo $module_full_name; ?> Description : <span  class="text-danger">*</span></label>
                                                                <textarea type="text" class="form-control" id="description"
                                                                    name="description" maxlength="200"
                                                                    placeholder="Enter <?php echo $module_full_name; ?> Description"
                                                                    data-parsley-required="true"><?php echo $description; ?></textarea> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="checkbox-inline">
                                                                    <input type="checkbox" name="is_myself" class="styled" id="is_myself" value="1" <?php if ($edit_data_array[0]['is_myself'] == 1)
                                                                        {
                                                                            echo "checked";
                                                                        } ?>>
                                                                    My Self
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="checkbox-inline">
                                                                    <input type="checkbox" name="is_someelse" class="styled" id="is_someelse" value="1" <?php if ($edit_data_array[0]['is_someelse'] == 1)
                                                                        {
                                                                            echo "checked";
                                                                        } ?>>
                                                                    Someone else
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="checkbox-inline">
                                                                    <input type="checkbox" name="is_occasion" class="styled" id="is_occasion" value="1" <?php if ($edit_data_array[0]['is_occasion'] == 1)
                                                                        {
                                                                            echo "checked";
                                                                        } ?>>
                                                                    Occasion
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="checkbox-inline">
                                                                    <input type="checkbox" name="is_date" class="styled" id="is_date" value="1" <?php if ($edit_data_array[0]['is_date'] == 1)
                                                                        {
                                                                            echo "checked";
                                                                        } ?>>
                                                                    Preferred Date
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label class="checkbox-inline">
                                                                    <input type="checkbox" name="is_message" class="styled" id="is_message" value="1" <?php if ($edit_data_array[0]['is_message'] == 1)
                                                                        {
                                                                            echo "checked";
                                                                        } ?>>
                                                                    Message
                            ...
                            $.ajax(
                                {
                                    ...
                                    success: function (data)
                                    {
                                        ...
                                        if (data.status == 'success')
                                        {
                                            ...
                                            setTimeout(function ()
                                            {
                                                window.top.location="<?php echo $base_url; ?>view-services";
                                            }, 2000);
                                        }
                                        else
                                        {
