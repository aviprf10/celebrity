...
if ($admin == 1)
{
    if (isset($_GET['id']))
    {
        $module_full_name = "Spoken Language";
        $module_short_name = "Spoken Language";
        ...
        {
            $edit_data_array[] = $row_get_spoken_language_query;
        }

         if (!empty($edit_data_array))
        {
            $edit_data = $edit_data_array[0];
            $spoken_language_id = $edit_data['id'];
            $language_name = $edit_data['language_name'];
            ...
            <script type="text/javascript">
                            ...
                            $.ajax(
                                {
                                    ...
                                    success: function (data)
                                    {
                                        ...
                                        if (data.status == 'success')
                                        {
                                            ...
                                            setTimeout(function ()
                                            {
                                                window.top.location="<?php echo $base_url; ?>view-spoken-language";
                                            }, 2000);
                                        }
                                        else
                                        {
                ...
                $(function ()
                {
                    ...
                    new AjaxUpload(btnUpload, {
                        action: '<?php echo $base_url; ?>upload-spoken_language-image.php',
                        name: 'uploadfile',
