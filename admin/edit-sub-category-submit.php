...
if ($admin == 1)
{
    if (isset($_POST))
    {
        ...
        if (!empty($all_category_data_array))
        {
            ...
            $update_category_query = "update sub_category set sub_category_name='$sub_category_name', category_id='$category_id', sub_category_imges='$images',meta_title='$meta_title', meta_keyword='$search_keywords', meta_description='$meta_description',updated_on='$updated_on',
