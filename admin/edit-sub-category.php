...
if ($admin == 1)
{
    if (isset($_GET['id']))
    {
         ...
         if (count($edit_data_array) > 0)
        {
            ...
            $sub_category_name = $edit_data['sub_category_name'];
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="sub_category_name"
                                                                       ...
                                                                       value="<?php echo $sub_category_name; ?>"
                                                                    ...
                                                                    { ?>
                                                                        <div id="upload<?php echo $i; ?>"
                                                                            ...
                                                                            <ul class="" id="files<?php echo $i; ?>"
                                                                                ...
                                                                                <?php
                                                                                if ($edit_data_array[0]['sub_category_imges'] != '')
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/sub-category-images/size_small/<?php echo $edit_data_array[0]['sub_category_imges']; ?>"
                                                                            ...
                                                                            <input type="hidden" name="file_name<?php echo $i; ?>"
                                                                                    id="file_name<?php echo $i; ?>" value="<?php echo $edit_data_array[0]['sub_category_imges']; ?>">
                                                                        </div>
                                                                        <?php
                                                                    } ?>
                                                                    <div style="clear:both"></div>
