...
if ($admin == 1)
{
    ...
    {
        $module_full_name = 'Testimonial';
        $module_short_name = 'Testimonial';
        ...
        {
            $edit_data_array[] = $row_get_testimonial_query;
        }
        ?>
        <!DOCTYPE html>
        <html lang="en">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="name" name="name" placeholder="Enter Name"  data-parsley-required="true" value="<?php echo $edit_data_array[0]['name']; ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" class="form-control" id="description" name="description" placeholder="Enter Description"  data-parsley-required="true"><?php echo $edit_data_array[0]['description']; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div> 
                                                <div class="row">
                                                                    ...
                                                                    <div id="upload<?php echo $i; ?>"
                                                                        ...
                                                                        <ul class="" id="files<?php echo $i; ?>"
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                {
                                                                                    ?>
                                                                                    <img src="<?php echo $base_url; ?>uploads/testimonial-images/size_small/<?php echo $edit_data_array[0]['images']; ?>"
                                                                                         style="margin-bottom:20px;width:295px;height:165px;">
                                                                                    <div style="clear:both"></div>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo $base_url_css_upload; ?>styles.css"/>
                            ...
                            $.ajax(
                                {
                                    ...
                                    success: function (data)
                                    {
                                        ...
                                        if (data.status == 'success')
                                        {
                                            ...
                                            setTimeout(function ()
                                            {
                                                window.top.location="<?php echo $base_url; ?>view-testimonial";
                                            }, 2000);
                                        }
                                        else
                                        {
            ...
            $(function ()
            {
                ...
                new AjaxUpload(btnUpload, {
                    action: '<?php echo $base_url; ?>upload-testimonial-image.php',
                    name: 'uploadfile',
    ...
    //                    debugger;
                        ...
                        if (file1 === "success")
                        {
                            ...
                            $('<li></li>').add('#files<?php echo $i; ?>').html('<img src="<?php echo $base_url_uploads;?>testimonial-images/size_small/' + file + '" style="margin-bottom:10px;width:290px;height:165px;"  alt="" /><div style="clear:both"></div><a class="" style="cursor:pointor" onclick="delete_upload(<?php echo $i;?>)"><i class="icon icon-subtract"></i><div style="clear:both"></div>DELETE </a>').addClass('success');
                            $('input').attr('title', ' ');
                        }
