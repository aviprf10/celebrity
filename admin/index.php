...
if ($admin == 1)
{
    $get_celebrity_query = "SELECT count(*) as total_celebrity from user WHERE user_type ='2' and is_deleted='0'";
    $result_get_celebrity_query = mysqli_query($db_mysqli, $get_celebrity_query);
    $all_celebrity_data_array = array();
    while ($row_get_celebrity_query = mysqli_fetch_assoc($result_get_celebrity_query))
    {
        $all_celebrity_data_array[] = $row_get_celebrity_query;
    }
    $total_celebrity = $all_celebrity_data_array[0]['total_celebrity'];

    $get_user_query = "SELECT count(*) as total_user from user WHERE user_type ='3' and is_deleted='0'";
    ...
    $total_user = $all_user_data_array[0]['total_user'];

    $get_brand_user_query = "SELECT count(*) as total_brand_user from brand_user WHERE is_deleted='0'";
    ...
    $total_brand_user = $all_brand_user_data_array[0]['total_brand_user'];

    $get_user_order_query = "SELECT count(*) as total_order from user_order WHERE is_deleted='0'";
    ...
    $get_brand_post_query = "SELECT count(*) as total_brand_post from brand_post WHERE is_deleted='0'";
    ...
    $get_occasion_query = "SELECT count(*) as total_occasion from occasion WHERE is_deleted='0'";
    ...
    $total_occasion = $all_occasion_data_array[0]['total_occasion'];

    $get_services_query = "SELECT count(*) as total_services from services WHERE is_deleted='0'";
    ...
    $total_services = $all_services_data_array[0]['total_services'];

    $get_services_request_query = "SELECT count(*) as total_services_request from services_request WHERE is_deleted='0'";
    ...
    $get_celebrity_messages_query = "SELECT count(*) as total_celebrity_messages from celebrity_messages WHERE is_deleted='0'";
    ...
    $total_celebrity_messages = $all_celebrity_messages_data_array[0]['total_celebrity_messages'];

    $get_spoken_language_query = "SELECT count(*) as total_spoken_language from spoken_language WHERE is_deleted='0'";
    ...
    $total_spoken_language = $all_spoken_language_data_array[0]['total_spoken_language'];

    $get_category_query = "SELECT count(*) as total_category from category WHERE is_deleted='0'";
    ...
    $total_category = $all_category_data_array[0]['total_category'];

    $get_gift_cat_query = "SELECT count(*) as total_gift_cat from gift_cat WHERE is_deleted='0'";
    ...
    $total_gift_cat = $all_gift_cat_data_array[0]['total_gift_cat'];

    $get_newuser_order_query = "SELECT count(*) as total_newuser_order from user_order WHERE is_deleted='0' and order_status='0'";
    ...
    $get_rejecteduser_order_query = "SELECT count(*) as total_rejecteduser_order from user_order WHERE is_deleted='0' and order_status='8'";
    ...
    $get_brand_inquery_response_query = "SELECT count(*) as total_brand_inquery_response from brand_inquery_response WHERE request_type='Accept'";
                ...
                <div class="content">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="card card-body bg-blue-400 has-bg-image" style="padding:30px;">
                                        <div class="media" style="display: flex; align-items: flex-start;">
                                            <div class="media-body" style="margin-top: -29px;">
                                                <h3 class="mb-0"><?php echo $total_celebrity; ?></h3>
                                                <span class="text-uppercase font-size-xs">total Celebrity</span>
                                            </div>
                                ...
                                <!-- <div class="col-md-3">
                                    <div class="card card-body bg-danger-400 has-bg-image" style="padding:30px;">
                                        <div class="media" style="display: flex; align-items: flex-start;">
                                            <div class="media-body" style="margin-top: -29px;">
                                                <h3 class="mb-0">5,193</h3>
                                                <span class="text-uppercase font-size-xs">total sub category</span>
                                            </div>
                                            <div class="ml-3 align-self-center">
                                                <i class="fa fa-handshake-o" style="opacity: .75; font-size: 48px;"></i>
                                            </div>
                                        </div>    
                                    </div>
                                </div> -->
                                <div class="col-md-3">
                                    <div class="card card-body bg-success-400 has-bg-image" style="padding:30px;">
                                        <div class="media" style="display: flex; align-items: flex-start;">
                                            <div class="ml-3 align-self-center">
                                                <i class="icon-users4 icon-3x opacity-75" style="opacity: .75;"></i>
                                            </div>
                                            <div class="media-body text-right" style="margin-top: -29px;">
                                ...
                                <div class="col-md-3">
                                    <div class="card card-body bg-indigo-400 has-bg-image" style="padding:30px;">
                                        <div class="media" style="display: flex; align-items: flex-start;">
                                            <div class="ml-3 align-self-center">
                                                <i class="icon-users4 icon-3x opacity-75" style="opacity: .75;"></i>
                                            </div>
                                            <div class="media-body text-right" style="margin-top: -29px;">
                                                <h3 class="mb-0"><?php echo $total_brand_user; ?></h3>
                                                <span class="text-uppercase font-size-xs">total brand user</span>
                                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="card card-body bg-orange-400 has-bg-image" style="padding:30px;">
                                        <div class="media" style="display: flex; align-items: flex-start;">
                                            <div class="media-body" style="margin-top: -29px;">
                                                <h3 class="mb-0"><?php echo $total_occasion; ?></h3>
                                                <span class="text-uppercase font-size-xs">total Occasion</span>
                                            </div>
                                            <div class="ml-3 align-self-center">
                                                <i class="icon-meter2 icon-3x opacity-75" style="opacity: .75;"></i>
                                            </div>
                                        </div>    
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="card card-body bg-silver-400 has-bg-image" style="padding:30px; background: cornsilk;">
                                        <div class="media" style="display: flex; align-items: flex-start;">
                                            <div class="media-body" style="margin-top: -29px;">
                                            ...
                                            <div class="ml-3 align-self-center">
                                                <i class="icon-wrench3 icon-3x opacity-75" style="opacity: .75;"></i>
                                            </div>
                                        </div>    
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="card card-body bg-red-400 has-bg-image" style="padding:30px;     background: red;">
                                        <div class="media" style="display: flex; align-items: flex-start;">
                                            <div class="media-body" style="margin-top: -29px;">
                                                <h3 class="mb-0" style="color:#fff;"><?php echo $total_celebrity_messages; ?></h3>
                                                <span class="text-uppercase font-size-xs" style="color:#fff;">total Messages</span>
                                            </div>
                                            <div class="ml-3 align-self-center">
                                                <i class="icon-bubbles2 icon-3x opacity-75" style="opacity: .75; color:#fff;"></i>
                                            </div>
                                        </div>    
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="card card-body bg-violet-400 has-bg-image" style="padding:30px; background: black;">
                                        <div class="media" style="display: flex; align-items: flex-start;">
                                            <div class="media-body" style="margin-top: -29px;">
                                                <h3 class="mb-0"><?php echo $total_spoken_language; ?></h3>
                                                <span class="text-uppercase font-size-xs">total Spoken Language </span>
                                            </div>
                                            <div class="ml-3 align-self-center">
                                                <i class="icon-volume-high icon-3x opacity-75" style="opacity: .75;"></i>
                                            </div>
                                        </div>    
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="card card-body bg-violet-400 has-bg-image" style="padding:30px; background: brown;">
                                        <div class="media" style="display: flex; align-items: flex-start;">
                                            <div class="media-body" style="margin-top: -29px;">
                                                <h3 class="mb-0"><?php echo $total_category; ?></h3>
                                                <span class="text-uppercase font-size-xs">total Category</span>
                                            </div>
                                            <div class="ml-3 align-self-center">
                                                <i class="icon-file-text icon-3x opacity-75" style="opacity: .75;"></i>
                                            </div>
                                        </div>    
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="card card-body bg-violet-400 has-bg-image" style="padding:30px; background: yellowgreen;">
                                        <div class="media" style="display: flex; align-items: flex-start;">
                                            <div class="media-body" style="margin-top: -29px;">
                                                <h3 class="mb-0"><?php echo $total_gift_cat; ?></h3>
                                                <span class="text-uppercase font-size-xs">total gift category</span>
                                            </div>
                                            <div class="ml-3 align-self-center">
                                                <i class="icon-gift icon-3x opacity-75" style="opacity: .75;"></i>
                                            </div>
                                        </div>    
                                    </div>
                                </div>
                                    ...
                                    <div class="card card-body bg-violet-400 has-bg-image" style="padding:30px; background: darkgoldenrod;">
                                        <div class="media" style="display: flex; align-items: flex-start;">
                                            <div class="media-body" style="margin-top: -29px;">
                                                ...
                                                <span class="text-uppercase font-size-xs">total celebrity accepted order </span>
                                            </div>
                                            <div class="ml-3 align-self-center">
