...
if ($admin == 1)
{
    if (isset($_POST))
    {
        ...
        if (count($all_company_info_data_array) > 0)
        {
            ...
            $pinterest_link = Secure1($db_mysqli, $_POST['pinterest_link']);
            ...
            $update_company_info_query = "UPDATE company_info
                                SET company_title = '$company_title', company_description='$company_description',company_address = '$company_address', company_email = '$company_email', company_email2 = '$company_email2',
                                  ...
                                  google_link  = '$google_link', linkedin_link = '$linkedin_link', skype_link = '$skype_link', youtube_link='$youtube_link', insta_link='$insta_link', whatsapp_link='$whatsapp_link', pintrest_link='$pintrest_link', updated_on='$updated_on'
                                WHERE id = '$edit_id';";
