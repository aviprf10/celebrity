...
if ($admin == 1)
{
	$temp_location = 'uploads/branch-images/temp_file/';
	$size_location1 = 'uploads/branch-images/size_extra_small/';
	$size_location2 = 'uploads/branch-images/size_small/';
	$size_location3 = 'uploads/branch-images/size_medium/';
	$size_location4 = 'uploads/branch-images/size_large/';
