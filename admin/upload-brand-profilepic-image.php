...
if ($admin == 1)
{
    $temp_location =  '../brand/uploads/profile-pic/temp_file/';
    $size_location1 = '../brand/uploads/profile-pic/size_100/';
    $size_location2 = '../brand/uploads/profile-pic/size_450/';
    ...
    if (move_uploaded_file($_FILES['uploadfile']['tmp_name'], $source_image_path))
    {
        ...
        resize_image($source_image_path, 450, 450, $destination_file_name, $size_location2, 75);
