...
{
	$temp_location = 'uploads/category-images/temp_file/';
	$size_location1 = 'uploads/category-images/size_extra_small/';
	$size_location2 = 'uploads/category-images/size_small/';
	$size_location3 = 'uploads/category-images/size_medium/';
	$size_location4 = 'uploads/category-images/size_large/';
