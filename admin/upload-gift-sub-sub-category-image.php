...
{
	$temp_location = 'uploads/gift-sub-sub-category-images/temp_file/';
	$size_location1 = 'uploads/gift-sub-sub-category-images/size_extra_small/';
	$size_location2 = 'uploads/gift-sub-sub-category-images/size_small/';
	$size_location3 = 'uploads/gift-sub-sub-category-images/size_medium/';
	$size_location4 = 'uploads/gift-sub-sub-category-images/size_large/';
	...
	if(move_uploaded_file($_FILES['uploadfile']['tmp_name'], $source_image_path)) 
	{
		...
		resize_image($source_image_path, 1920,758, $destination_file_name,$size_location4,75);
