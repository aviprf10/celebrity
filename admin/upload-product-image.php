...
if ($admin == 1)
{
	$temp_location = 'uploads/product-images/temp_file/';
	$size_location1 = 'uploads/product-images/size_extra_small/';
	$size_location2 = 'uploads/product-images/size_small/';
	$size_location3 = 'uploads/product-images/size_medium/';
	$size_location4 = 'uploads/product-images/size_large/';
