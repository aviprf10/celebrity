...
{
	$temp_location = 'uploads/sub-category-images/temp_file/';
	$size_location1 = 'uploads/sub-category-images/size_extra_small/';
	$size_location2 = 'uploads/sub-category-images/size_small/';
	$size_location3 = 'uploads/sub-category-images/size_medium/';
	$size_location4 = 'uploads/sub-category-images/size_large/';
