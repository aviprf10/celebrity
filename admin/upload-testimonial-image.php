...
if ($admin == 1)
{
	$temp_location = 'uploads/testimonial-images/temp_file/';
	$size_location1 = 'uploads/testimonial-images/size_extra_small/';
	$size_location2 = 'uploads/testimonial-images/size_small/';
	$size_location3 = 'uploads/testimonial-images/size_medium/';
	$size_location4 = 'uploads/testimonial-images/size_large/';
	...
	if(move_uploaded_file($_FILES['uploadfile']['tmp_name'], $source_image_path)) 
	{
		...
		resize_image($source_image_path, 695,800, $destination_file_name,$size_location4,75);
