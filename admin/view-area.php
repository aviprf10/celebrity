						...
						<div class="col-lg-12">
							...
							>
								<div class="panel-heading">
									...
									<?php if($admin == 1 || ($sub_admin == 1 && $is_city_write == 1)){?>
...
<!--												<th>id</th>-->
											...
											<tr>
												<td></td>
                                                <td><input type="text" id="search_city" name="search_city"
														   class="<?php echo $module_name; ?>-search-input form-control">
												</td>
												<td><input type="text" id="search_country" name="search_country"
														   class="<?php echo $module_name; ?>-search-input form-control">
												</td>
												<td><input type="text" id="search_pincode" name="search_pincode"
														   class="<?php echo $module_name; ?>-search-input form-control">
												</td>
												<td>
...
//            $('.checker span').prop("indeterminate", true)
        ...
        //        // Handle click on checkbox to set city of "Select all" control
        $('#all-<?php echo $module_name; ?>-table tbody').on('change', 'input[type="checkbox"]', function ()
        {
            ...
            if (!this.checked)
            {
                ...
                {
                    // Set visual city of "Select all" control
                    // as 'indeterminate'
		...
		$("#search_city,#search_country").on("keydown", function (e) {
