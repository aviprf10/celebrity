...
if ($admin == 1 || ($sub_admin == 1 && $is_city_read == 1))
{
	...
	<head>
		...
		<style>
            ...
            /*.select2-selection--single, .select2-container, .select2-selection {*/
                /*line-height: 1;*/
            /*}*/
...
<!--												<th>id</th>-->
											...
											<tr>
												...
												<td><input type="text" id="search_state" name="search_state"
														   class="<?php echo $module_name; ?>-search-input form-control">
												</td>
...
//            $('.checker span').prop("indeterminate", true)
		...
		$("#search_city,#search_state,#search_country").on("keydown", function (e) {
