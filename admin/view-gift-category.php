                                    ...
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" id="search_gift_name" name="search_gift_name"
                                                           class="<?php echo $module_name; ?>-search-input form-control">
                                                </td>
                                                <td>
...
//            debugger;
        ...
        $("#search_gift_name,#search_gift-category_code").on("keydown", function (e) {
            if (e.keyCode === 13) {  //checks whether the pressed key is "Enter"
                load_data();
            }
        });
