                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            <tr>
                                                <th>ID</th>
                                                <th>Gift Sub Category</th>
                                                <th>Gift Sub Sub Category Title</th>
                                                <th>Status</th>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" id="search_subcategory_title" name="search_subcategory_title"
                                                           class="<?php echo $module_name; ?>-search-input form-control">
                                                </td>
                                                <td><input type="text" id="search_subsubcategory_title" name="search_subsubcategory_title"
                                                           class="<?php echo $module_name; ?>-search-input form-control">
                                                </td>
                                                <td>
...
//            debugger;
            if (reset_flag == 0)            //call to load_data() when on first table load or when search button is clicked
            {
                ...
                form_data =
                {
                    "search_subcategory_title": $('#search_subcategory_title').val(),
                    "search_subsubcategory_title": $('#search_subsubcategory_title').val(),
                    "search_status": search_status
                };
            }
            else if (reset_flag == 1)           //call to load_data() when reset button is clicked
            {
                $('#search_subcategory_title').val('');
                $('#search_subsubcategory_title').val('');

                form_data =
                {
                    "search_subcategory_title": '',
                    "search_subsubcategory_title": '',
                    "search_status": ''
                }
            }
        ...
        $("#search_subcategory_title,#search_subsubcategory_title").on("keydown", function (e) {
            if (e.keyCode === 13) {  //checks whether the pressed key is "Enter"
                load_data();
            }
        });
