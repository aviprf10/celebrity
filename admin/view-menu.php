...
<!--												<th>id</th>-->
											...
											<tr>
												...
												<td><input type="text" id="search_price" name="search_price"
														   class="<?php echo $module_name; ?>-search-input form-control">
												</td>
												<td><input type="text" id="search_area" name="search_area"
														   class="<?php echo $module_name; ?>-search-input form-control">
												</td>
												<td>
...
//            debugger;
			if(reset_flag == 0)			//call to load_data() when on first table load or when search button is clicked
			{
				...
				form_data =
				{
					"search_menu_name": $('#search_menu_name').val(),
