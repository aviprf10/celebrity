...
<!--												<th>id</th>-->
											...
											<tr>
												...
												<td><input type="text" id="search_messages" name="search_messages"
														   class="<?php echo $module_name; ?>-search-input form-control">
												</td>
												<td>
...
//            debugger;
			if(reset_flag == 0)			//call to load_data() when on first table load or when search button is clicked
			{
				...
				form_data =
				{
					...
					"search_messages": $('#search_messages').val(),
...
//            console.log(arrayOfIds);
            if (arrayOfIds == '')
            {
                bootbox.alert("Please select title!");
            }
            else
            {
...
//            $('.checker span').prop("indeterminate", true)
        ...
        //        // Handle click on checkbox to set title of "Select all" control
        $('#all-<?php echo $module_name; ?>-table tbody').on('change', 'input[type="checkbox"]', function ()
        {
            ...
            if (!this.checked)
            {
                ...
                {
                    // Set visual title of "Select all" control
                    // as 'indeterminate'
		...
		$("#search_title,#search_messages").on("keydown", function (e) {
