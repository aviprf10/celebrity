                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" id="search_id" name="search_id" class="<?php echo $module_name; ?>-search-input form-control">
                                                </td>
                                                <td>
                                                    <input type="text" id="search_category_title" name="search_category_title" class="<?php echo $module_name; ?>-search-input form-control">
                                                </td>
                                                <td>
