...
//    echo $requestData;
    ...
    if (count($all_user_data_array) > 0)
    {
        foreach ($all_user_data_array as $all_user_data)
        {
            ...
            $nestedData = array();
            $nestedData[] = $row_id;
            $nestedData[] = '<video width="320" height="240" controls controlsList="nodownload">
            ...
            $nestedData[] = '
                <center>
                 <a href="' . $base_url1 . 'edit-video-history/' . $row_id . '" title="Edit" class="tooltip_class" data-popup="tooltip"><i class="fa fa-eye" aria-hidden="true"></i></a>
                    &nbsp;&nbsp;
                </center>';
