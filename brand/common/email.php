...
function send_email($email_array)
{
   ...
   $base_url='http://localhost/celebrity/brand';
   ...
   /*$social_media_link_array = $email_array['social_media_link'];
	...
	else if($email_type == 3) // Order delevry user Mail
	{
		$send_email = 1;
		$user_name = $email_array['user_name'];
		$description = $email_array['description'];
		$validate_day = $email_array['validate_day'];
		$brand_name = $email_array['brand_name'];
		$price = $email_array['price'];

		$mail->Subject = "Brand Request ";
		$email_body .= 
		'<table border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed;background-color:#f9f9f9" id="bodyTable">
		<tbody>
		   <tr>
		                           ...
		                           <td align="center" valign="top">
									...
									<tr>
			                           <td cellpadding="10" align="left" class="editable" style="padding:10px;color: rgb(35, 35, 35); font-size: 14px; font-family: Raleway, sans-serif, Arial; font-weight: normal; line-height: 1.3; outline: none; outline-offset: 2px;" data-selector="td.editable" contenteditable="false"> 
			                           		Add new band request and brand details
									...
									<tr>
										<td class="editable" style="font-size: 14px; color: rgb(35, 35, 35); text-align: left; font-family: Raleway, sans-serif, Arial; font-weight: normal; line-height: 1.4; outline: none; outline-offset: 2px; padding-left: 14px;" data-selector="td.editable" contenteditable="false"><b>Reply Days  :</b>'.$validate_day.'</td>
									</tr>
									<tr>
										<td class="editable" style="font-size: 14px; color: rgb(35, 35, 35); text-align: left; font-family: Raleway, sans-serif, Arial; font-weight: normal; line-height: 1.4; outline: none; outline-offset: 2px; padding-left: 14px;" data-selector="td.editable" contenteditable="false"><b>Budget :</b>'.$price.'</td>
									</tr>
									<tr>
										<td class="editable" style="font-size: 14px; color: rgb(35, 35, 35); text-align: left; font-family: Raleway, sans-serif, Arial; font-weight: normal; line-height: 1.4; outline: none; outline-offset: 2px; padding-left: 14px;" data-selector="td.editable" contenteditable="false"><b>Brand Description :</b>'.$description.'</td>
									</tr>
									<tr>
                                       <td align="center" valign="top" class="btnCard" style="padding-bottom:40px;padding-left:20px;padding-right:20px">
                                          <table border="0" cellpadding="0" cellspacing="0" align="center">
