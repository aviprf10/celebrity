      ...
      <div class="container">
         <div class="row">
               ...
               <div class="col-12 col-sm-12 col-md-6 col-lg-6 footer-about">
                  <img src="<?php echo $base_url_images; ?>ftr-logo-demo5.png" alt="Optimal" class="mb-3" width="160" height="33" />
               ...
               <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-contact">
                  ...
                  <p class="address d-flex align-items-center" style="color:#fff;">
                     <i class="an an-map-marker-al" style="color:#fff;"></i><?php echo $master_settings_data_array[0]['company_address']; ?> <?php echo $master_settings_data_array[0]['company_address2']; ?>  <?php echo $master_settings_data_array[0]['city']; ?>-<?php echo $master_settings_data_array[0]['pincode']; ?>, <?php echo $master_settings_data_array[0]['state']; ?>, 23568 <?php echo $master_settings_data_array[0]['country']; ?></p>
   ...
   <div class="footer-bottom clearfix bg-transparent">
      <div class="container">
         <div class="d-flex-center flex-column justify-content-md-between flex-md-row-reverse">
               ...
               <div class="copytext" style="color:#fff;">&copy; <?php echo date('Y'); ?> Optimal. All Rights Reserved.</div>
         </div>
      </div>
   </div>
</div>
