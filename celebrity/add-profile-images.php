							...
							<div class="panel panel-default">
								...
								<div class="panel-body">
									<form  id="<?php echo $module_name; ?>_form" method="POST" data-parsley-validate>
										...
										<div class="row">
											<div class="col-md-4" style="margin-top:10px;margin-bottom: 15px; display:none;"  id="images_div">
                                                <div class="form-group">
                                                    <label>Upload big image (Image Size 800X960PX and 2MB):</label>
                                            ...
                                            <div class="col-md-4" style="margin-top:10px;margin-bottom: 15px; display:none;" id="video_div">
                                                <div class="form-group">
                                                    ...
                                                    <div style="margin-top:10px;margin-bottom: 15px;">
                                                        ...
                                                        { ?>
                                                            <div id="upload<?php echo $i; ?>"
                                                                ...
                                                                <ul class="" id="files<?php echo $i; ?>"
                                                                    style="width: auto;padding: 0px;margin:0px">
                                                                    <center style="margin-top: 20px;"><i class="icon icon-add"></i><div style="clear:both"></div>ADD <br/> VIDEO </center>
                                                                </ul>
                                                                <input type="hidden" name="file_name<?php echo $i; ?>"
                                                                       id="file_name<?php echo $i; ?>" value="">
                                                            </div>
