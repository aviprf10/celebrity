...
if ($celebrity == 1)
{
    ...
    if (isset($_POST))
    {
        ...
        if(!empty($check_brandpost_title_data_array))
        {
            ...
            $get_brandpost_query = "select bpc.*, bp.id as brand_post_id from  brand_post_celebrty_list bpc left join brand_post bp on bpc.brand_post_id=bp.id where bpc.id='$edit_id'";
            ...
            celebrity_id='$celebrity_id', brand_id='$brand_post_id', brand_post_celebrty_id='$edit_id',request_type='$request_type', rejct_reason='$rejct_reason', display_mailid='$display_mailid', status_by='$status_by',updated_on='$created_on' 
            ...
            VALUES ('$celebrity_id','$brand_post_id','$response_id','$web_access_token','$web_token_exp_date', '$created_on')";
            ...
            $email_array1['web_access_token'] = $web_access_token;
            $email_array1['email_type'] = 5;
            $email_sent_response1 = send_email($email_array1);

            $return["web_access_token"] = $web_access_token;
            $return["html_message"] = 'Your response updated successfully.';
        ...
        else 
        {
           ...
           $insert_brandpost_query = "INSERT INTO brand_inquery_response (celebrity_id, brand_id, brand_post_celebrty_id,request_type,rejct_reason, display_mailid, status_by, created_on) 
            VALUES ('$celebrity_id','$brand_post_id','$edit_id','$request_type','$rejct_reason','$display_mailid', '$status_by','$created_on')";
            $result_insert_brandpost_query = mysqli_query($db_mysqli, $insert_brandpost_query);
            ...
            $return["web_access_token"] = $web_access_token;
            $return["html_message"] = 'Your response added successfully.';
            $return["status"] = "success";
            echo json_encode($return);
            exit();
