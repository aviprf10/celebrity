...
if ($celebrity == 1)
{
    if (isset($_GET['id']))
    {
        ...
        $brand_post_id = $edit_data_array[0]['brand_post_id'];
        ...
        if (!empty($edit_data_array))
        {
            ...
            echo $get_brandidquery = "select * from brand_inquery_response where brand_id='$brand_post_id'";
                            ...
                            $.ajax(
                                {
                                    ...
                                    success: function (data)
                                    {
                                        ...
                                        if (data.status == 'success')
                                        {
                                            ...
                                            setTimeout(function ()
                                            {
                                                window.open("<?php echo $base_url; ?>upload-video/"+data.web_access_token, "_blank");
                                            }, 2000);
