    ...
    if ($_POST)
    {
        ...
        $html_message = ' <div class="form-group">
            <label>Select State : <span class="text-danger">*</span></label>
                <select class="select-search form-control" id="state_id" name="state_id" data-placeholder="Select a State..." onchange="if(' . $edit_flag . ') get_city(this.value);invalidate_parsley(this.id)">
                    <option></option>';
