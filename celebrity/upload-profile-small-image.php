...
if ($celebrity == 1)
{
	$temp_location = 'uploads/product-small-images/temp_file/';
	$size_location1 = 'uploads/product-small-images/size_extra_small/';
	$size_location2 = 'uploads/product-small-images/size_small/';
	$size_location3 = 'uploads/product-small-images/size_medium/';
	$size_location4 = 'uploads/product-small-images/size_large/';
	...
	if(move_uploaded_file($_FILES['uploadfile']['tmp_name'], $source_image_path)) 
	{
		...
		resize_image($source_image_path, 360,414, $destination_file_name,$size_location4,75);
