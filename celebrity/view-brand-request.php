...
if ($celebrity == 1)
{
    $module_full_name = "Brand Request";
    $module_short_name = "Brand Request";
    $module_name = "brand-request";
    ?>
    <!DOCTYPE html>
    <html lang="en">
    <head>
                                    ...
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" id="search_title" name="search_title" class="<?php echo $module_name; ?>-search-input form-control">
                                                </td>
                                                <td>
                                                </td>
                                                <td>
