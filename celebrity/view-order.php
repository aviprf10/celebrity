                                    ...
                                    <div class="panel-body">
                                            <form id="view_order_form" method="POST" data-parsley-validate>
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label>Buyer Instagram ID : </label> 
                                                            <input class="form-control"  type="text" value="<?php echo $edit_data_array[0]['instagram_link']; ?>" readonly>
                                                        </div>
                                                    </div> 
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control"  type="text" name="name" id="name" value="<?php echo $edit_data_array[0]['name']; ?>" data-parsley-required="true">
                                                        </div>
                                                    </div> 
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Message : </label> 
                                                            <textarea class="form-control" rows="5"  readonly><?php echo $edit_data_array[0]['user_message']; ?></textarea>
                                                        </div>
                                                    </div>       
                                                </div> 
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control"  type="text" readonly  value="<?php echo $edit_data_array[0]['occasion_title']; ?>" >
                                                        </div>
                                                    </div> 
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <img src="<?php echo $base_path_uploads; ?>profile-pic/temp_file/<?php echo $edit_data_array[0]['profile_pic']; ?>" style="width:200px;">
                                                        </div>
                                                    </div>        
                                                </div> 
                                                <div class="row">
                                                ...
                                                <?php if(!empty($edit_data_array[0]['cancel_by_user'])){ 
