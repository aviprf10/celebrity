...
if ($celebrity == 1)
{
    ...
    $module_full_name = "Payment History";
    $module_short_name = "Payment History";
    $module_name = "payment";
    ?>
    <!DOCTYPE html>
    <html lang="en">
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <p style="float: right; font-size: 17px;"><b>Total Balance : <?php echo $selected_currency_icon; ?>  <?php echo $main_amount; ?>.00</b></p>    
                                    ...
                                    <div class="table-responsive">
                                        <table
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" id="search_celebrity" name="search_celebrity"
                                                           class="<?php echo $module_name; ?>-search-input form-control">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input type="text" id="search_credit_amt" name="search_credit_amt"
                                                           class="<?php echo $module_name; ?>-search-input form-control">
                                                </td>
                                                <td>
                                                    <input type="text" id="search_debit_amt" name="search_debit_amt"
                                                           class="<?php echo $module_name; ?>-search-input form-control">
                                                </td>
                                                <td>
                                                    <input type="text" id="search_amount" name="search_amount"
                                                           class="<?php echo $module_name; ?>-search-input form-control">
                                                </td>
                                                <td>
                                                </td>
...
//            debugger;
            if (reset_flag == 0)            //call to load_data() when on first table load or when search button is clicked
            {
                ...
                form_data =
                {
                    ...
                    "search_celebrity": $('#search_celebrity').val(),
