        ...
        <header id="header" class="header header-main mih-70 d-flex align-items-center header-5">
            <div class="container">        
                <div class="row">
                    <div class="col-6 col-sm-6 col-md-6 col-lg-2 align-self-center justify-content-start d-flex">
                        ...
                        <div class="logo"><a href="<?php echo $base_url; ?>"><img class="logo-img" src="<?php echo $base_url_images; ?>logo.png" alt="Wish Vader" title="Wish Vader" /><span class="logo-txt d-none">Wish Vader</span></a></div>
                    </div>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <?php 
                                        ...
                                        <li class="has-megasubmenu" id="dd" <?php if($i>1){ ?> style="border-top: 1px solid #eeeeee; position: relative;" <?php } ?>>
                                            <a class="dropdown-item" href="<?php echo $base_url; ?>gifting/best-birthday-gift-for-<?php echo $gift_cat_data['gift_slug']; ?>"> <img src="<?php echo $base_path_uploads ?>gift-category-images/temp_file/<?php echo $gift_cat_data['gift_images']; ?>" style="max-width: 10% !important;  margin-right: 10px;"><?php echo $gift_cat_data['gift_name']; ?> <?php if(count($gift_subcat_data_array) > 0){ ?><i class="an an-angle-right-l" style="font-size: 18px; position: absolute; right: 5px; top: 8px;"></i><?php } ?></a>
                    ...
                    <div class="col-6 col-sm-6 col-md-6 col-lg-3 align-self-center icons-col text-right d-flex justify-content-end">
                        <!--Search-->
                        <div class="site-search iconset"><i class="icon an an-search-l d-block d-lg-none"></i><span class="text d-none d-lg-flex fw-bold">Search</span></div>
                        <?php 
                        if($user==1)
                        {
                        ?>
                        ...
                        <div id="userLinks">
                            ...
                            <ul class="user-links">
                                ...
                                <li><a href="<?php echo $base_url; ?>my-wishlist">Wishlist</a></li>
                                <li><a href="<?php echo $base_url; ?>my-order">My Order</a></li>
                        ...
                        <div class="user-link iconset quick-view-popup quick-view" data-toggle="modal" data-target="#content_quickview"><i class="icon an an-user-expand"></i></div>
                         <?php } ?>
                        <div class="header-cart iconset" id="cart">
                            <a href="#" id="cart_box"class="site-header__cart btn-minicart">
                                <i class="icon an an-sq-bag"></i>
                                <span id="header_cart_total_count" class="site-cart-count counter d-flex-center justify-content-center position-absolute translate-middle rounded-circle">
                                    <?php echo $_SESSION['total_user_cart_data_'.$company_name_session]; ?>
                                </span>
            ...
            <div id="search-popup" class="search-drawer">
                <div class="container">
                    ...
                    <form class="form minisearch" id="header_search_form">
                        <label class="label"><span>Search</span></label>
                        <div class="control">
                            <div class="searchField">
                                 <div class="input-box">
                                    <button type="submit" title="Search" class="action search" disabled=""><i class="icon an an-search-l"></i></button>
                                    <input type="text" name="q" id="search_value" placeholder="Search by celebrity.." class="input-text">
                                </div>
                            </div>
                        </div>
                    </form>
                    <div id="search_div" style="display:none; padding-left:0px !important;">
                        <div class="search-ajax__result row d-none-important">
                            <ul class="dropdown-menu" role="menu" id="search_product_result_ul" >
                                <div id="SearchContainer"></div>
                                <div style="text-align: center;">
                                    <a href="<?php echo $base_url ?>/celebrity-list" class="btn-link">View all</a>
                                </div>
                            </ul> 
                    ...
                    <ul class="dropdown">
                        ...
                        if(count($category_data_array) > 0){
                            foreach($category_data_array as $category_data){
                                $cat_id = $category_data['id'];
                                $subcategory_data_array = array();
                                $get_subcategory_query = "SELECT * FROM `sub_category` as sc left join celebrity_details cd on cd.sub_category_id=sc.id where sc.category_id='$cat_id' and sc.is_deleted='0'and cd.sub_category_id IS NOT NULL group by sc.id having count(*) > 0";
                                $result_get_subcategory_query = mysqli_query($db_mysqli, $get_subcategory_query);
                                while ($row_get_subcategory_query = mysqli_fetch_assoc($result_get_subcategory_query))
                                {
                                    $subcategory_data_array[] = $row_get_subcategory_query;
