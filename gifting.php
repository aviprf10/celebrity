        ...
        <div class="collection-header">
            <div class="collection-hero">
                ...
                <div class="collection-hero__title-wrapper container">
                    <h2 class="collection-hero__title">Best Gift For <?php echo $gift_name; ?></h2>
                    <div class="breadcrumbs text-uppercase mt-1 mt-lg-2"><a href="<?php $base_url;?>" title="Back to the home page">Home</a><span>/</span><span class="fw-bold">Best Gift For  <?php echo $gift_name; ?></span></div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                            ...
                            <form  method="post" class="price-filter filterDD">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input id="category_title" type="hidden" value="<?php echo $gift_slug; ?>">
                                    </p>
                                    </div>
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-9 main-col">
                    ...
                    <div class="collection-description pt-0" style="padding-bottom:0px;">
                        <div class="widget-title"><h2> Best Birthday Gift For <?php echo $giftsubsubcate_name; ?></h2></div>
                    </div>
