...
<body class="template-index index-demo5">
   ...
   <div id="page-content">
         ...
         <div class="home-slideshow">
            ...
            <div class="slide">
                  <div class="blur-up lazyload">
                     <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 d-flex align-items-center p-0 order-md-<?php echo $i ?> order-xl-<?php if($i == '0'){ echo $i+1;}else{ echo $i;} ?> order-sm-<?php echo $i ?> order-lg-<?php if($i == '0'){ echo $i+1;}else{ echo $i;} ?> order-<?php echo $i ?>">
      ...
      <?php 
         ...
         foreach ($categorysec_id as $key => $value) {
            if($key=='0'){
               ...
               $get_movieartist_query = "select u.*, cp.price, cp.status as price_status, cp.discount_type, cp.discount from user u left join celebrity_details c on u.id=c.celebrity_id left join celebrity_price cp on u.id=cp.celebrity_id where c.category_id IN($value) and u.status='1' and u.is_deleted='0' and u.user_type='2' and cp.price > '0' and cp.status='1' group by u.id  order by id desc limit 6";
                  ...
                  <?php 
                     if(count($movieartist_data_array) > 0)
                     {
                        foreach($movieartist_data_array as $movieartist_data){
                           ...
                           if($movieartist_data['price_status'] == 1)
                           {
      ...
      <?php 
            ...
            $get_influencers_query = "select u.*, cp.price, cp.status as price_status, cp.discount_type, cp.discount from user u left join celebrity_details c on u.id=c.celebrity_id left join celebrity_price cp on u.id=cp.celebrity_id where c.category_id IN($value) and u.status='1' and u.is_deleted='0' and u.user_type='2' and cp.price > '0' and cp.status='1' group by u.id  order by id desc limit 6";
               ...
               <?php 
                     if(count($influencers_data_array) > 0)
                     {
                        foreach($influencers_data_array as $influencers_data){
                           ...
                           if($influencers_data['price_status'] == 1)
                           {
      ...
      <?php 
         ...
         foreach ($categorysec_id as $key => $value) {
            if($key=='2'){
               ...
               $get_music_query = "select u.*, cp.price, cp.status as price_status, cp.discount_type, cp.discount from user u left join celebrity_details c on u.id=c.celebrity_id left join celebrity_price cp on u.id=cp.celebrity_id where c.category_id IN($value) and u.status='1' and u.is_deleted='0' and u.user_type='2' and cp.price > '0' and cp.status='1' group by u.id  order by id desc limit 6";
      ...
      <?php 
            ...
            $get_models_query = "select u.*, cp.price, cp.status as price_status, cp.discount_type, cp.discount from user u left join celebrity_details c on u.id=c.celebrity_id left join celebrity_price cp on u.id=cp.celebrity_id where c.category_id IN($value) and u.status='1' and u.is_deleted='0' and u.user_type='2' and cp.price > '0' and cp.status='1' group by u.id  order by id desc limit 6";
      ...
      <?php 
         ...
         foreach ($categorysec_id as $key => $value) {
            if($key=='4'){
               ...
               $get_athletes_query = "select u.*, cp.price, cp.status as price_status, cp.discount_type, cp.discount from user u left join celebrity_details c on u.id=c.celebrity_id left join celebrity_price cp on u.id=cp.celebrity_id where c.category_id IN($value) and u.status='1' and u.is_deleted='0' and u.user_type='2' and cp.price > '0' and cp.status='1' group by u.id  order by id desc limit 6";
               ...
               <?php 
                     if(count($athletes_data_array) > 0)
                     {
                        foreach($athletes_data_array as $athletes_data){
                           ...
                           if($athletes_data['price_status'] == 1)
                           {
                  ...
                  <div class="item">
                     <div class="product-image">
                           <a href="<?php echo $base_url; ?>celebrity-details/<?php echo $athletes_data['user_unique_slug']; ?>" class="product-img">
                              <?php if($athletes_data['profile_pic'] !=''){ ?>
      ...
      <?php 
            ...
            $get_tvartist_query = "select u.*, cp.price, cp.status as price_status, cp.discount_type, cp.discount from user u left join celebrity_details c on u.id=c.celebrity_id left join celebrity_price cp on u.id=cp.celebrity_id where c.category_id IN($value) and u.status='1' and u.is_deleted='0' and u.user_type='2' and cp.price > '0' and cp.status='1' group by u.id  order by id desc limit 6";
               ...
               <?php 
                     if(count($tvartist_data_array) > 0)
                     {
                        foreach($tvartist_data_array as $tvartist_data){
                           ...
                           if($tvartist_data['price_status'] == 1)
                           {  
                  ...
                  <div class="item">
                     <div class="product-image">
                           <a href="<?php echo $base_url; ?>celebrity-details/<?php echo $tvartist_data['user_unique_slug']; ?>" class="product-img">
                              <?php if($tvartist_data['profile_pic'] !=''){ ?>
