                                        ...
                                        <?php
                                            ...
                                            if (count($celebrity_data_array) > 0)
                                            {
                                                ...
                                                foreach ($celebrity_data_array as $celebrity_data)
                                                {
                                                    ...
                                                    $total_discout_price += $celebrity_data['total_discout_price'];
                                               ...
                                               // $final_order_total_amount = $order_total_amount + 0 - $total_discountt;
                                            }
                                            ?>
                                            <span> <b> Subtotal :</b> </span> <?php echo $selected_currency_icon; ?> <?php echo $celebrity_price; ?>.00 <br/>
                                            <span><b> Discount(-) : </b></span> <?php echo $selected_currency_icon; ?><?php echo $total_discout_price; ?><br>

                                            <span><b> Order Total : </b></span> <?php echo $selected_currency_icon; ?> <?php echo $total_discount; ?>.00 <br/>
                                    </div>
                                </div>
                            </div><br>
                            <?php
                                ...
                                <table class="table table-bordered table-hover align-middle text-center mb-0">
                                    ...
                                    <?php 
                                        ...
                                        { 
                                            ...
                                            $celebrity_price = $order_data['price']+0;
